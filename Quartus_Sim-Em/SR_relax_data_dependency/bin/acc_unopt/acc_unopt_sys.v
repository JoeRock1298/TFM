...
(
   ...
   // INST double_add_1_std_ic_inst of double_add_1_std_ic_partition_wrapper
   double_add_1_std_ic_partition_wrapper double_add_1_std_ic_inst
   (
      .clock(clock),
      .clock2x(clock2x),
      .resetn(resetn),
      .cra_irq_double_add_1(kernel_irqs),
      // AVS avs_double_add_1_cra
      .avs_double_add_1_cra_enable(cra_ring_node_avm_wire_0_enable),
      .avs_double_add_1_cra_read(cra_ring_node_avm_wire_0_read),
      .avs_double_add_1_cra_write(cra_ring_node_avm_wire_0_write),
      .avs_double_add_1_cra_address(cra_ring_node_avm_wire_0_address),
      .avs_double_add_1_cra_writedata(cra_ring_node_avm_wire_0_writedata),
      .avs_double_add_1_cra_byteenable(cra_ring_node_avm_wire_0_byteenable),
      .avs_double_add_1_cra_readdata(cra_ring_node_avm_wire_0_readdata),
      .avs_double_add_1_cra_readdatavalid(cra_ring_node_avm_wire_0_readdatavalid),
      // AVM double_add_1_0_avm_lm_double_add_1
      .double_add_1_0_avm_lm_double_add_1_enable(gmem0_DDR_global_avm_enable[0]),
      .double_add_1_0_avm_lm_double_add_1_read(gmem0_DDR_global_avm_read[0]),
      .double_add_1_0_avm_lm_double_add_1_write(gmem0_DDR_global_avm_write[0]),
      .double_add_1_0_avm_lm_double_add_1_address(gmem0_DDR_global_avm_address[0]),
      .double_add_1_0_avm_lm_double_add_1_writedata(gmem0_DDR_global_avm_writedata[0]),
      .double_add_1_0_avm_lm_double_add_1_byteenable(gmem0_DDR_global_avm_byteenable[0]),
      .double_add_1_0_avm_lm_double_add_1_waitrequest(gmem0_DDR_global_avm_waitrequest[0]),
      .double_add_1_0_avm_lm_double_add_1_readdata(gmem0_DDR_global_avm_readdata[0]),
      .double_add_1_0_avm_lm_double_add_1_readdatavalid(gmem0_DDR_global_avm_readdatavalid[0]),
      .double_add_1_0_avm_lm_double_add_1_burstcount(gmem0_DDR_global_avm_burstcount[0]),
      .double_add_1_0_avm_lm_double_add_1_writeack(gmem0_DDR_global_avm_writeack[0]),
      // AVM double_add_1_0_avm_memdep_double_add_1
      .double_add_1_0_avm_memdep_double_add_1_enable(gmem0_DDR_global_avm_enable[1]),
      .double_add_1_0_avm_memdep_double_add_1_read(gmem0_DDR_global_avm_read[1]),
      .double_add_1_0_avm_memdep_double_add_1_write(gmem0_DDR_global_avm_write[1]),
      .double_add_1_0_avm_memdep_double_add_1_address(gmem0_DDR_global_avm_address[1]),
      .double_add_1_0_avm_memdep_double_add_1_writedata(gmem0_DDR_global_avm_writedata[1]),
      .double_add_1_0_avm_memdep_double_add_1_byteenable(gmem0_DDR_global_avm_byteenable[1]),
      .double_add_1_0_avm_memdep_double_add_1_waitrequest(gmem0_DDR_global_avm_waitrequest[1]),
      .double_add_1_0_avm_memdep_double_add_1_readdata(gmem0_DDR_global_avm_readdata[1]),
      .double_add_1_0_avm_memdep_double_add_1_readdatavalid(gmem0_DDR_global_avm_readdatavalid[1]),
      .double_add_1_0_avm_memdep_double_add_1_burstcount(gmem0_DDR_global_avm_burstcount[1]),
      .double_add_1_0_avm_memdep_double_add_1_writeack(gmem0_DDR_global_avm_writeack[1])
   );
...
/////////////////////////////////////////////////////////////////
// MODULE double_add_1_std_ic_partition_wrapper
/////////////////////////////////////////////////////////////////
module double_add_1_std_ic_partition_wrapper
(
   input logic clock,
   input logic clock2x,
   input logic resetn,
   output logic cra_irq_double_add_1,
   // AVS avs_double_add_1_cra
   input logic avs_double_add_1_cra_enable,
   input logic avs_double_add_1_cra_read,
   input logic avs_double_add_1_cra_write,
   input logic [4:0] avs_double_add_1_cra_address,
   input logic [63:0] avs_double_add_1_cra_writedata,
   input logic [7:0] avs_double_add_1_cra_byteenable,
   output logic [63:0] avs_double_add_1_cra_readdata,
   output logic avs_double_add_1_cra_readdatavalid,
   // AVM double_add_1_0_avm_lm_double_add_1
   output logic double_add_1_0_avm_lm_double_add_1_enable,
   output logic double_add_1_0_avm_lm_double_add_1_read,
   output logic double_add_1_0_avm_lm_double_add_1_write,
   output logic [30:0] double_add_1_0_avm_lm_double_add_1_address,
   output logic [511:0] double_add_1_0_avm_lm_double_add_1_writedata,
   output logic [63:0] double_add_1_0_avm_lm_double_add_1_byteenable,
   input logic double_add_1_0_avm_lm_double_add_1_waitrequest,
   input logic [511:0] double_add_1_0_avm_lm_double_add_1_readdata,
   input logic double_add_1_0_avm_lm_double_add_1_readdatavalid,
   output logic [4:0] double_add_1_0_avm_lm_double_add_1_burstcount,
   input logic double_add_1_0_avm_lm_double_add_1_writeack,
   // AVM double_add_1_0_avm_memdep_double_add_1
   output logic double_add_1_0_avm_memdep_double_add_1_enable,
   output logic double_add_1_0_avm_memdep_double_add_1_read,
   output logic double_add_1_0_avm_memdep_double_add_1_write,
   output logic [30:0] double_add_1_0_avm_memdep_double_add_1_address,
   output logic [511:0] double_add_1_0_avm_memdep_double_add_1_writedata,
   output logic [63:0] double_add_1_0_avm_memdep_double_add_1_byteenable,
   input logic double_add_1_0_avm_memdep_double_add_1_waitrequest,
   input logic [511:0] double_add_1_0_avm_memdep_double_add_1_readdata,
   input logic double_add_1_0_avm_memdep_double_add_1_readdatavalid,
   output logic [4:0] double_add_1_0_avm_memdep_double_add_1_burstcount,
   input logic double_add_1_0_avm_memdep_double_add_1_writeack
);
   logic double_add_1_start;
   logic [0:0] double_add_1_start_chain;
   logic [0:0] double_add_1_start_kernel_copy;
   logic [0:0] double_add_1_start_task_fd;
   logic [0:0] double_add_1_start_finish_element;
   logic double_add_1_finish;
   logic [0:0] double_add_1_finish_kernel_copy;
   logic [0:0] double_add_1_finish_chain;
   logic [63:0] double_add_1_global_size [2:0];
   logic [31:0] double_add_1_num_groups [2:0];
   logic [31:0] double_add_1_local_size [2:0];
   logic [63:0] double_add_1_global_offset [2:0];
   logic [31:0] double_add_1_work_dim;
   logic [31:0] double_add_1_wg_size;
   logic [0:0] double_add_1_wg_disp_stall_in;
   logic [0:0] double_add_1_wg_disp_stall_in_lookahead;
   logic [0:0] double_add_1_wg_disp_valid_out;
   logic double_add_1_wg_disp_start_out;
   logic [31:0] double_add_1_wg_disp_group_id_out [2:0];
   logic [31:0] double_add_1_wg_disp_global_id_base_out [2:0];
   logic double_add_1_wg_disp_dispatched_all_groups;
   logic [63:0] double_add_1_global_id [1][2:0];
   logic [31:0] double_add_1_local_id [1][2:0];
   logic [31:0] double_add_1_group_id [1][2:0];
   logic [0:0] double_add_1_pending_write;
   logic [0:0] double_add_1_lsu_active;
   logic [0:0] double_add_1_valid_in;
   logic [0:0] double_add_1_valid_out;
   logic [0:0] double_add_1_stall_in;
   logic [0:0] double_add_1_stall_out;
   logic double_add_1_cra_pending_write;
   logic double_add_1_cra_lsu_active;
   logic double_add_1_cra_valid_in;
   logic [159:0] double_add_1_kernel_arguments;

   assign double_add_1_start_chain[0] = double_add_1_start;
   assign double_add_1_finish_chain[0] = 1'b1;
   assign double_add_1_cra_pending_write = |double_add_1_pending_write;
   assign double_add_1_cra_lsu_active = |double_add_1_lsu_active;
   assign double_add_1_cra_valid_in = |double_add_1_valid_in;
   assign double_add_1_stall_in = 0;
   // INST double_add_1_workgroup_dispatcher of acl_work_group_dispatcher
   ...
   double_add_1_workgroup_dispatcher
   (
      .clock(clock),
      .resetn(resetn),
      .start(double_add_1_start),
      .num_groups(double_add_1_num_groups),
      .local_size(double_add_1_local_size),
      .stall_in(double_add_1_wg_disp_stall_in),
      .stall_in_lookahead(double_add_1_wg_disp_stall_in_lookahead),
      .valid_out(double_add_1_wg_disp_valid_out),
      .group_id_out(double_add_1_wg_disp_group_id_out),
      .global_id_base_out(double_add_1_wg_disp_global_id_base_out),
      .start_out(double_add_1_wg_disp_start_out),
      .dispatched_all_groups(double_add_1_wg_disp_dispatched_all_groups)
   );

   // INST double_add_1_finish_detector of acl_kernel_finish_detector
   ...
   double_add_1_finish_detector
   (
      .clock(clock),
      .resetn(resetn),
      .start(double_add_1_start),
      .wg_size(double_add_1_wg_size),
      .wg_dispatch_valid_out(double_add_1_wg_disp_valid_out),
      .wg_dispatch_stall_in(double_add_1_wg_disp_stall_in),
      .dispatched_all_groups(double_add_1_wg_disp_dispatched_all_groups),
      .kernel_copy_valid_out(double_add_1_valid_out),
      .kernel_copy_stall_in(double_add_1_stall_in),
      .pending_writes(double_add_1_cra_pending_write),
      .finish(double_add_1_finish)
   );

   // INST double_add_1_cra_slave_inst of double_add_1_function_cra_slave
   double_add_1_function_cra_slave double_add_1_cra_slave_inst
   (
      .clock(clock),
      .resetn(resetn),
      .start(double_add_1_start),
      .finish(double_add_1_finish),
      .global_offset_0(double_add_1_global_offset[0]),
      .global_offset_1(double_add_1_global_offset[1]),
      .global_offset_2(double_add_1_global_offset[2]),
      .work_dim(double_add_1_work_dim),
      .has_a_lsu_active(double_add_1_cra_lsu_active),
      .has_a_write_pending(double_add_1_cra_pending_write),
      .valid_in(double_add_1_cra_valid_in),
      .global_size_0(double_add_1_global_size[0]),
      .global_size_1(double_add_1_global_size[1]),
      .global_size_2(double_add_1_global_size[2]),
      .num_groups_0(double_add_1_num_groups[0]),
      .num_groups_1(double_add_1_num_groups[1]),
      .num_groups_2(double_add_1_num_groups[2]),
      .local_size_0(double_add_1_local_size[0]),
      .local_size_1(double_add_1_local_size[1]),
      .local_size_2(double_add_1_local_size[2]),
      .workgroup_size(double_add_1_wg_size),
      .kernel_arguments(double_add_1_kernel_arguments),
      .cra_irq(cra_irq_double_add_1),
      // AVS avs_cra
      .avs_cra_enable(avs_double_add_1_cra_enable),
      .avs_cra_read(avs_double_add_1_cra_read),
      .avs_cra_write(avs_double_add_1_cra_write),
      .avs_cra_address(avs_double_add_1_cra_address),
      .avs_cra_writedata(avs_double_add_1_cra_writedata),
      .avs_cra_byteenable(avs_double_add_1_cra_byteenable),
      .avs_cra_readdata(avs_double_add_1_cra_readdata),
      .avs_cra_readdatavalid(avs_double_add_1_cra_readdatavalid)
   );

   // INST double_add_1_id_iter_inst_0 of acl_id_iterator
   acl_id_iterator
   #(
      .WIDTH(32),
      .LOCAL_WIDTH_X(32),
   ...
   double_add_1_id_iter_inst_0
   (
      .clock(clock),
      .resetn(resetn),
      .start(double_add_1_wg_disp_start_out),
      .valid_in(double_add_1_wg_disp_valid_out[0]),
      .stall_out(double_add_1_wg_disp_stall_in[0]),
      .stall_out_lookahead(double_add_1_wg_disp_stall_in_lookahead[0]),
      .stall_in(double_add_1_stall_out[0]),
      .valid_out(double_add_1_valid_in[0]),
      .group_id_in(double_add_1_wg_disp_group_id_out),
      .global_id_base_in(double_add_1_wg_disp_global_id_base_out),
      .local_size(double_add_1_local_size),
      .global_size(double_add_1_global_size),
      .global_work_offset(double_add_1_global_offset),
      .local_id(double_add_1_local_id[0]),
      .global_id(double_add_1_global_id[0]),
      .group_id(double_add_1_group_id[0])
   );

   // INST double_add_1_inst_0 of double_add_1_top_wrapper_0
   double_add_1_top_wrapper_0 double_add_1_inst_0
   (
      .start(double_add_1_start_kernel_copy[0]),
      .kernel_arguments(double_add_1_kernel_arguments),
      .work_dim(double_add_1_work_dim),
      .global_offset(double_add_1_global_offset),
      .kernel_valid_out(double_add_1_valid_out[0]),
      .has_a_write_pending(double_add_1_pending_write[0]),
      .has_a_lsu_active(double_add_1_lsu_active[0]),
      .global_id(double_add_1_global_id[0]),
      .local_id(double_add_1_local_id[0]),
      .group_id(double_add_1_group_id[0]),
      .global_size(double_add_1_global_size),
      ...
      .num_groups(double_add_1_num_groups),
      .workgroup_size(double_add_1_wg_size),
      .kernel_stall_out(double_add_1_stall_out[0]),
      .kernel_valid_in(double_add_1_valid_in[0]),
      .clock(clock),
      .resetn(resetn),
      .clock2x(clock2x),
      // AVM avm_lm_double_add_1
      .avm_lm_double_add_1_enable(double_add_1_0_avm_lm_double_add_1_enable),
      .avm_lm_double_add_1_read(double_add_1_0_avm_lm_double_add_1_read),
      .avm_lm_double_add_1_write(double_add_1_0_avm_lm_double_add_1_write),
      .avm_lm_double_add_1_address(double_add_1_0_avm_lm_double_add_1_address),
      .avm_lm_double_add_1_writedata(double_add_1_0_avm_lm_double_add_1_writedata),
      .avm_lm_double_add_1_byteenable(double_add_1_0_avm_lm_double_add_1_byteenable),
      .avm_lm_double_add_1_waitrequest(double_add_1_0_avm_lm_double_add_1_waitrequest),
      .avm_lm_double_add_1_readdata(double_add_1_0_avm_lm_double_add_1_readdata),
      .avm_lm_double_add_1_readdatavalid(double_add_1_0_avm_lm_double_add_1_readdatavalid),
      .avm_lm_double_add_1_burstcount(double_add_1_0_avm_lm_double_add_1_burstcount),
      .avm_lm_double_add_1_writeack(double_add_1_0_avm_lm_double_add_1_writeack),
      // AVM avm_memdep_double_add_1
      .avm_memdep_double_add_1_enable(double_add_1_0_avm_memdep_double_add_1_enable),
      .avm_memdep_double_add_1_read(double_add_1_0_avm_memdep_double_add_1_read),
      .avm_memdep_double_add_1_write(double_add_1_0_avm_memdep_double_add_1_write),
      .avm_memdep_double_add_1_address(double_add_1_0_avm_memdep_double_add_1_address),
      .avm_memdep_double_add_1_writedata(double_add_1_0_avm_memdep_double_add_1_writedata),
      .avm_memdep_double_add_1_byteenable(double_add_1_0_avm_memdep_double_add_1_byteenable),
      .avm_memdep_double_add_1_waitrequest(double_add_1_0_avm_memdep_double_add_1_waitrequest),
      .avm_memdep_double_add_1_readdata(double_add_1_0_avm_memdep_double_add_1_readdata),
      .avm_memdep_double_add_1_readdatavalid(double_add_1_0_avm_memdep_double_add_1_readdatavalid),
      .avm_memdep_double_add_1_burstcount(double_add_1_0_avm_memdep_double_add_1_burstcount),
      .avm_memdep_double_add_1_writeack(double_add_1_0_avm_memdep_double_add_1_writeack)
   );

   // INST double_add_1_start_elem_inst_0 of acl_start_signal_chain_element
   acl_start_signal_chain_element
   #(
      .ASYNC_RESET(1),
      .SYNCHRONIZE_RESET(0)
   )
   double_add_1_start_elem_inst_0
   (
      .clock(clock),
      .resetn(resetn),
      .start_in(double_add_1_start_chain[0]),
      .start_kernel(double_add_1_start_kernel_copy[0]),
      .start_finish_detector(double_add_1_start_task_fd[0]),
      .start_finish_chain_element(double_add_1_start_finish_element[0]),
      .start_chain()
   );
...
/////////////////////////////////////////////////////////////////
// MODULE double_add_1_top_wrapper_0
/////////////////////////////////////////////////////////////////
module double_add_1_top_wrapper_0
(
   input logic start,
   ...
   input logic clock2x,
   // AVM avm_lm_double_add_1
   output logic avm_lm_double_add_1_enable,
   output logic avm_lm_double_add_1_read,
   output logic avm_lm_double_add_1_write,
   output logic [30:0] avm_lm_double_add_1_address,
   output logic [511:0] avm_lm_double_add_1_writedata,
   output logic [63:0] avm_lm_double_add_1_byteenable,
   input logic avm_lm_double_add_1_waitrequest,
   input logic [511:0] avm_lm_double_add_1_readdata,
   input logic avm_lm_double_add_1_readdatavalid,
   output logic [4:0] avm_lm_double_add_1_burstcount,
   input logic avm_lm_double_add_1_writeack,
   // AVM avm_memdep_double_add_1
   output logic avm_memdep_double_add_1_enable,
   output logic avm_memdep_double_add_1_read,
   output logic avm_memdep_double_add_1_write,
   output logic [30:0] avm_memdep_double_add_1_address,
   output logic [511:0] avm_memdep_double_add_1_writedata,
   output logic [63:0] avm_memdep_double_add_1_byteenable,
   input logic avm_memdep_double_add_1_waitrequest,
   input logic [511:0] avm_memdep_double_add_1_readdata,
   input logic avm_memdep_double_add_1_readdatavalid,
   output logic [4:0] avm_memdep_double_add_1_burstcount,
   input logic avm_memdep_double_add_1_writeack
);
   logic lmem_invalid_single_bit;

   // INST kernel of double_add_1_function_wrapper
   double_add_1_function_wrapper kernel
   (
      ...
      .clock2x(clock2x),
      // AVM avm_lm_double_add_1
      .avm_lm_double_add_1_enable(avm_lm_double_add_1_enable),
      .avm_lm_double_add_1_read(avm_lm_double_add_1_read),
      .avm_lm_double_add_1_write(avm_lm_double_add_1_write),
      .avm_lm_double_add_1_address(avm_lm_double_add_1_address),
      .avm_lm_double_add_1_writedata(avm_lm_double_add_1_writedata),
      .avm_lm_double_add_1_byteenable(avm_lm_double_add_1_byteenable),
      .avm_lm_double_add_1_waitrequest(avm_lm_double_add_1_waitrequest),
      .avm_lm_double_add_1_readdata(avm_lm_double_add_1_readdata),
      .avm_lm_double_add_1_readdatavalid(avm_lm_double_add_1_readdatavalid),
      .avm_lm_double_add_1_burstcount(avm_lm_double_add_1_burstcount),
      .avm_lm_double_add_1_writeack(avm_lm_double_add_1_writeack),
      // AVM avm_memdep_double_add_1
      .avm_memdep_double_add_1_enable(avm_memdep_double_add_1_enable),
      .avm_memdep_double_add_1_read(avm_memdep_double_add_1_read),
      .avm_memdep_double_add_1_write(avm_memdep_double_add_1_write),
      .avm_memdep_double_add_1_address(avm_memdep_double_add_1_address),
      .avm_memdep_double_add_1_writedata(avm_memdep_double_add_1_writedata),
      .avm_memdep_double_add_1_byteenable(avm_memdep_double_add_1_byteenable),
      .avm_memdep_double_add_1_waitrequest(avm_memdep_double_add_1_waitrequest),
      .avm_memdep_double_add_1_readdata(avm_memdep_double_add_1_readdata),
      .avm_memdep_double_add_1_readdatavalid(avm_memdep_double_add_1_readdatavalid),
      .avm_memdep_double_add_1_burstcount(avm_memdep_double_add_1_burstcount),
      .avm_memdep_double_add_1_writeack(avm_memdep_double_add_1_writeack)
   );
...
(
   ...
   begin:gmem0_DDR_
      ...
      // INST global_ic_preroutegmem0_DDR_router_0 of acc_unopt_sys_ic_18004512899439049807
      acc_unopt_sys_ic_18004512899439049807 global_ic_preroutegmem0_DDR_router_0
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
      ...
      // INST global_ic_preroutegmem0_DDR_router_1 of acc_unopt_sys_ic_10753627231702743408
      acc_unopt_sys_ic_10753627231702743408 global_ic_preroutegmem0_DDR_router_1
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
      ...
      // INST global_icgmem0_DDR_port_0_0_rw of acc_unopt_sys_ic_7539638572835371438
      acc_unopt_sys_ic_7539638572835371438 global_icgmem0_DDR_port_0_0_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE acc_unopt_sys_ic_18004512899439049807
/////////////////////////////////////////////////////////////////
module acc_unopt_sys_ic_18004512899439049807
(
   input logic clock,
...
/////////////////////////////////////////////////////////////////
// MODULE acc_unopt_sys_ic_10753627231702743408
/////////////////////////////////////////////////////////////////
module acc_unopt_sys_ic_10753627231702743408
(
   input logic clock,
...
/////////////////////////////////////////////////////////////////
// MODULE acc_unopt_sys_ic_7539638572835371438
/////////////////////////////////////////////////////////////////
module acc_unopt_sys_ic_7539638572835371438
(
   input logic clock,
