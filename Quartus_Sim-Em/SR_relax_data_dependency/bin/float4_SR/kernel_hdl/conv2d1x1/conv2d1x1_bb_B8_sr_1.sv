...
// SystemVerilog created from conv2d1x1_bb_B8_sr_1
...
module conv2d1x1_bb_B8_sr_1 (
    ...
    input wire [32:0] in_i_data_22_tpl,
    ...
    input wire [0:0] in_i_data_75_tpl,
    ...
    output wire [32:0] out_o_data_22_tpl,
    ...
    output wire [0:0] out_o_data_75_tpl,
    input wire clock,
    input wire resetn
    );
    ...
    reg [0:0] data_mux_70_x_q;
    wire [0:0] data_mux_71_x_s;
    reg [0:0] data_mux_71_x_q;
    ...
    // out_o_stall(GPOUT,161)
    assign out_o_stall = sr_valid_q;

    // out_o_valid(GPOUT,162)
    ...
    begin
        if (!resetn)
        begin
            sr_22_x_q <= $unsigned(33'b000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_22_x_s)
            ...
            default : data_mux_22_x_q = 33'b0;
        endcase
    end

    // out_o_data_22_tpl(GPOUT,185)
    ...
    begin
        unique case (data_mux_45_x_s)
            ...
            default : data_mux_45_x_q = 1'b0;
        endcase
    end

    // out_o_data_45_tpl(GPOUT,208)
    ...
    begin
        unique case (data_mux_46_x_s)
            ...
            default : data_mux_46_x_q = 1'b0;
        endcase
    end

    // out_o_data_46_tpl(GPOUT,209)
    ...
    begin
        unique case (data_mux_47_x_s)
            ...
            default : data_mux_47_x_q = 1'b0;
        endcase
    end

    // out_o_data_47_tpl(GPOUT,210)
    ...
    begin
        unique case (data_mux_49_x_s)
            ...
            default : data_mux_49_x_q = 1'b0;
        endcase
    end

    // out_o_data_49_tpl(GPOUT,212)
    ...
    begin
        if (!resetn)
        begin
            sr_51_x_q <= $unsigned(1'b0);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
            sr_51_x_q <= in_i_data_51_tpl;
        end
    end
    ...
    begin
        unique case (data_mux_51_x_s)
            ...
            default : data_mux_51_x_q = 1'b0;
        endcase
    end

    // out_o_data_51_tpl(GPOUT,214)
    ...
    begin
        if (!resetn)
        begin
            sr_64_x_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
            sr_64_x_q <= $unsigned(in_i_data_64_tpl);
        end
    end
    ...
    begin
        unique case (data_mux_64_x_s)
            ...
            default : data_mux_64_x_q = 32'b0;
        endcase
    end

    // out_o_data_64_tpl(GPOUT,227)
    ...
    begin
        ...
        begin
            sr_65_x_q <= $unsigned(in_i_data_65_tpl);
        end
    end
    ...
    begin
        if (!resetn)
        begin
            sr_70_x_q <= $unsigned(1'b0);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
            sr_70_x_q <= in_i_data_70_tpl;
        end
    end
    ...
    begin
        unique case (data_mux_70_x_s)
            ...
            default : data_mux_70_x_q = 1'b0;
        endcase
    end

    // out_o_data_70_tpl(GPOUT,233)
    ...
    begin
        if (!resetn)
        begin
            sr_71_x_q <= $unsigned(1'b0);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
            sr_71_x_q <= in_i_data_71_tpl;
        end
    end
    ...
    begin
        unique case (data_mux_71_x_s)
            ...
            default : data_mux_71_x_q = 1'b0;
        endcase
    end

    // out_o_data_71_tpl(GPOUT,234)
    ...
    begin
        if (!resetn)
        begin
            sr_75_x_q <= $unsigned(1'b0);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
            sr_75_x_q <= in_i_data_75_tpl;
        end
    end
    ...
    begin
        unique case (data_mux_75_x_s)
            ...
            default : data_mux_75_x_q = 1'b0;
        endcase
    end

    // out_o_data_75_tpl(GPOUT,238)
