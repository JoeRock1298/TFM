...
module conv2d1x1_B6_branch (
    input wire [0:0] in_c0_exe1974134,
    ...
    // c0_exe1974134_cmp(LOGICAL,2)
    assign c0_exe1974134_cmp_q = ~ (in_c0_exe1974134);

    // valid_out_1_and(LOGICAL,21)
    assign valid_out_1_and_q = in_valid_in & c0_exe1974134_cmp_q;
    ...
    assign valid_out_0_and_q = in_valid_in & in_c0_exe1974134;
