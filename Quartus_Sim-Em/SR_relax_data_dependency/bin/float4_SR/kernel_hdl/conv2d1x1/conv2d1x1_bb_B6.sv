...
module conv2d1x1_bb_B6 (
    input wire [0:0] in_c0_exe1974134_0,
    ...
    wire [0:0] bb_conv2d1x1_B6_stall_region_out_c0_exe1974134;
    ...
    wire [0:0] conv2d1x1_B6_merge_out_c0_exe1974134;
    ...
    conv2d1x1_B6_branch theconv2d1x1_B6_branch (
        .in_c0_exe1974134(bb_conv2d1x1_B6_stall_region_out_c0_exe1974134),
    ...
    conv2d1x1_bb_B6_stall_region thebb_conv2d1x1_B6_stall_region (
        .in_c0_exe1974134(conv2d1x1_B6_merge_out_c0_exe1974134),
        .in_stall_in(conv2d1x1_B6_branch_out_stall_out),
        .in_valid_in(conv2d1x1_B6_merge_out_valid_out),
        .out_c0_exe1974134(bb_conv2d1x1_B6_stall_region_out_c0_exe1974134),
    ...
    conv2d1x1_B6_merge theconv2d1x1_B6_merge (
        .in_c0_exe1974134_0(in_c0_exe1974134_0),
        .in_stall_in(bb_conv2d1x1_B6_stall_region_out_stall_out),
        .in_valid_in_0(in_valid_in_0),
        .out_c0_exe1974134(conv2d1x1_B6_merge_out_c0_exe1974134),
