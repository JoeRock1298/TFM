...
// SystemVerilog created from conv2d1x1_B1_merge
...
module conv2d1x1_B1_merge (
    ...
    assign out_c0_exe1018 = in_c0_exe1018_0;

    // out_c0_exe1119(GPOUT,21)
    assign out_c0_exe1119 = in_c0_exe1119_0;

    // out_c0_exe1220(GPOUT,22)
    assign out_c0_exe1220 = in_c0_exe1220_0;

    // out_c0_exe1321(GPOUT,23)
    assign out_c0_exe1321 = in_c0_exe1321_0;

    // out_c0_exe1422(GPOUT,24)
    assign out_c0_exe1422 = in_c0_exe1422_0;

    // out_c0_exe1523(GPOUT,25)
    assign out_c0_exe1523 = in_c0_exe1523_0;

    // out_c0_exe1624(GPOUT,26)
    assign out_c0_exe1624 = in_c0_exe1624_0;

    // out_c0_exe1725(GPOUT,27)
    assign out_c0_exe1725 = in_c0_exe1725_0;

    // out_c0_exe210(GPOUT,28)
    assign out_c0_exe210 = in_c0_exe210_0;

    // out_c0_exe311(GPOUT,29)
    assign out_c0_exe311 = in_c0_exe311_0;

    // out_c0_exe412(GPOUT,30)
    assign out_c0_exe412 = in_c0_exe412_0;

    // out_c0_exe513(GPOUT,31)
    assign out_c0_exe513 = in_c0_exe513_0;

    // out_c0_exe614(GPOUT,32)
    assign out_c0_exe614 = in_c0_exe614_0;

    // out_c0_exe715(GPOUT,33)
    assign out_c0_exe715 = in_c0_exe715_0;

    // out_c0_exe816(GPOUT,34)
    assign out_c0_exe816 = in_c0_exe816_0;

    // out_c0_exe917(GPOUT,35)
    assign out_c0_exe917 = in_c0_exe917_0;
