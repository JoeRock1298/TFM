...
// SystemVerilog created from conv2d1x1_bb_B7_sr_0
...
module conv2d1x1_bb_B7_sr_0 (
    input wire [0:0] in_i_stall,
    input wire [0:0] in_i_valid,
    input wire [0:0] in_i_data_0_tpl,
    input wire [31:0] in_i_data_0_15_tpl,
    input wire [0:0] in_i_data_1_tpl,
    input wire [31:0] in_i_data_1_15_tpl,
    input wire [31:0] in_i_data_2_tpl,
    input wire [31:0] in_i_data_2_15_tpl,
    input wire [31:0] in_i_data_3_tpl,
    input wire [31:0] in_i_data_3_15_tpl,
    ...
    output wire [31:0] out_o_data_0_15_tpl,
    output wire [0:0] out_o_data_1_tpl,
    output wire [31:0] out_o_data_1_15_tpl,
    output wire [31:0] out_o_data_2_tpl,
    output wire [31:0] out_o_data_2_15_tpl,
    output wire [31:0] out_o_data_3_tpl,
    output wire [31:0] out_o_data_3_15_tpl,
    ...
    reg [31:0] sr_28_x_q;
    reg [31:0] sr_29_x_q;
    wire [0:0] data_mux_15_0_x_s;
    reg [31:0] data_mux_15_0_x_q;
    wire [0:0] data_mux_15_1_x_s;
    reg [31:0] data_mux_15_1_x_q;
    wire [0:0] data_mux_15_2_x_s;
    reg [31:0] data_mux_15_2_x_q;
    wire [0:0] data_mux_15_3_x_s;
    reg [31:0] data_mux_15_3_x_q;
    reg [31:0] sr_15_0_x_q;
    reg [31:0] sr_15_1_x_q;
    reg [31:0] sr_15_2_x_q;
    reg [31:0] sr_15_3_x_q;
    ...
    // out_o_stall(GPOUT,104)
    assign out_o_stall = sr_valid_q;

    // out_o_valid(GPOUT,105)
    ...
    begin
        if (!resetn)
        begin
            sr_15_0_x_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
            sr_15_0_x_q <= $unsigned(in_i_data_0_15_tpl);
        end
    end

    // data_mux_15_0_x(MUX,65)
    assign data_mux_15_0_x_s = sr_valid_q;
    always @(data_mux_15_0_x_s or in_i_data_0_15_tpl or sr_15_0_x_q)
    begin
        unique case (data_mux_15_0_x_s)
            1'b0 : data_mux_15_0_x_q = in_i_data_0_15_tpl;
            1'b1 : data_mux_15_0_x_q = sr_15_0_x_q;
            default : data_mux_15_0_x_q = 32'b0;
        endcase
    end

    // out_o_data_0_15_tpl(GPOUT,107)
    assign out_o_data_0_15_tpl = data_mux_15_0_x_q;
    ...
    begin
        if (!resetn)
        begin
            sr_15_1_x_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
            sr_15_1_x_q <= $unsigned(in_i_data_1_15_tpl);
        end
    end

    // data_mux_15_1_x(MUX,66)
    assign data_mux_15_1_x_s = sr_valid_q;
    always @(data_mux_15_1_x_s or in_i_data_1_15_tpl or sr_15_1_x_q)
    begin
        unique case (data_mux_15_1_x_s)
            1'b0 : data_mux_15_1_x_q = in_i_data_1_15_tpl;
            1'b1 : data_mux_15_1_x_q = sr_15_1_x_q;
            default : data_mux_15_1_x_q = 32'b0;
        endcase
    end

    // out_o_data_1_15_tpl(GPOUT,109)
    assign out_o_data_1_15_tpl = data_mux_15_1_x_q;
    ...
    begin
        if (!resetn)
        begin
            sr_15_2_x_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
            sr_15_2_x_q <= $unsigned(in_i_data_2_15_tpl);
        end
    end

    // data_mux_15_2_x(MUX,67)
    assign data_mux_15_2_x_s = sr_valid_q;
    always @(data_mux_15_2_x_s or in_i_data_2_15_tpl or sr_15_2_x_q)
    begin
        unique case (data_mux_15_2_x_s)
            1'b0 : data_mux_15_2_x_q = in_i_data_2_15_tpl;
            1'b1 : data_mux_15_2_x_q = sr_15_2_x_q;
            default : data_mux_15_2_x_q = 32'b0;
        endcase
    end

    // out_o_data_2_15_tpl(GPOUT,111)
    assign out_o_data_2_15_tpl = data_mux_15_2_x_q;
    ...
    begin
        if (!resetn)
        begin
            sr_15_3_x_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
            sr_15_3_x_q <= $unsigned(in_i_data_3_15_tpl);
        end
    end

    // data_mux_15_3_x(MUX,68)
    assign data_mux_15_3_x_s = sr_valid_q;
    always @(data_mux_15_3_x_s or in_i_data_3_15_tpl or sr_15_3_x_q)
    begin
        unique case (data_mux_15_3_x_s)
            1'b0 : data_mux_15_3_x_q = in_i_data_3_15_tpl;
            1'b1 : data_mux_15_3_x_q = sr_15_3_x_q;
            default : data_mux_15_3_x_q = 32'b0;
        endcase
    end

    // out_o_data_3_15_tpl(GPOUT,113)
    assign out_o_data_3_15_tpl = data_mux_15_3_x_q;
    ...
    begin
        ...
        begin
            sr_26_x_q <= $unsigned(in_i_data_26_tpl);
        end
    end

    // data_mux_26_x(MUX,32)
    ...
    begin
        ...
        begin
            sr_27_x_q <= $unsigned(in_i_data_27_tpl);
        end
    end

    // data_mux_27_x(MUX,33)
