...
module conv2d1x1_bb_B0_stall_region (
    ...
    // conv2d1x1_B0_merge_reg(BLACKBOX,5)@0
    ...
    // SE_out_conv2d1x1_B0_merge_reg(STALLENABLE,26)
    // Valid signal propagation
    assign SE_out_conv2d1x1_B0_merge_reg_V0 = SE_out_conv2d1x1_B0_merge_reg_wireValid;
    // Backward Stall generation
    assign SE_out_conv2d1x1_B0_merge_reg_backStall = i_llvm_fpga_pop_throttle_i1_throttle_pop_conv2d1x10_out_stall_out | ~ (SE_out_conv2d1x1_B0_merge_reg_wireValid);
    // Computing multiple Valid(s)
    assign SE_out_conv2d1x1_B0_merge_reg_wireValid = conv2d1x1_B0_merge_reg_out_valid_out;

    // SE_out_i_llvm_fpga_pop_throttle_i1_throttle_pop_conv2d1x10(STALLENABLE,28)
    // Valid signal propagation
    ...
    // Computing multiple Valid(s)
    assign SE_out_i_llvm_fpga_pop_throttle_i1_throttle_pop_conv2d1x10_wireValid = i_llvm_fpga_pop_throttle_i1_throttle_pop_conv2d1x10_out_valid_out;

    // GND(CONSTANT,0)
    assign GND_q = $unsigned(1'b0);

    // i_llvm_fpga_pop_throttle_i1_throttle_pop_conv2d1x10(BLACKBOX,11)@1
    // in in_stall_in@20000000
    // out out_data_out@2
