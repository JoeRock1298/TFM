...
// SystemVerilog created from double_add_2_B6_branch
...
module double_add_2_B6_branch (
    input wire [0:0] in_c0_exe272,
    input wire [0:0] in_c0_exe474,
    ...
    wire [0:0] c0_exe474_cmp_q;
    reg [0:0] c0_exe575_reg_q;
    reg [0:0] c0_exe6_reg_q;
    wire [0:0] double_add_2_B6_branch_enable_q;
    wire [0:0] double_add_2_B6_branch_enable_not_q;
    ...
    // c0_exe474_cmp(LOGICAL,3)
    assign c0_exe474_cmp_q = ~ (in_c0_exe474);

    // valid_out_1_and(LOGICAL,30)
    assign valid_out_1_and_q = in_valid_in & c0_exe474_cmp_q;
    ...
    begin
        ...
        else if (double_add_2_B6_branch_enable_q == 1'b1)
        begin
    ...
    assign valid_out_0_and_q = in_valid_in & in_c0_exe474;
    ...
    // double_add_2_B6_branch_enable(LOGICAL,6)
    assign double_add_2_B6_branch_enable_q = not_valid_or_not_stall_0_q & not_valid_or_not_stall_1_q;
    ...
    // double_add_2_B6_branch_enable_not(LOGICAL,7)
    assign double_add_2_B6_branch_enable_not_q = ~ (double_add_2_B6_branch_enable_q);

    // out_stall_out(GPOUT,24)
    assign out_stall_out = double_add_2_B6_branch_enable_not_q;
