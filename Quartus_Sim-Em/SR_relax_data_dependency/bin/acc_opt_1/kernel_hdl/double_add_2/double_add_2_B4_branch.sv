...
module double_add_2_B4_branch (
    input wire [0:0] in_c0_exe160,
    input wire [0:0] in_c0_exe3,
    input wire [0:0] in_c0_exe4,
    input wire [0:0] in_memdep_phi5_pop17,
    ...
    // out_memdep_phi5_pop17(GPOUT,11)
    assign out_memdep_phi5_pop17 = in_memdep_phi5_pop17;
