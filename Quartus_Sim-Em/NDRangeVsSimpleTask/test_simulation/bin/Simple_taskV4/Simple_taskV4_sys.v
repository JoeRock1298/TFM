...
(
   ...
   (
      ...
      // AVM mmul_0_avm_lm7_mmul
      .mmul_0_avm_lm7_mmul_enable(gmem0_DDR_global_avm_enable[0]),
      .mmul_0_avm_lm7_mmul_read(gmem0_DDR_global_avm_read[0]),
      .mmul_0_avm_lm7_mmul_write(gmem0_DDR_global_avm_write[0]),
      .mmul_0_avm_lm7_mmul_address(gmem0_DDR_global_avm_address[0]),
      .mmul_0_avm_lm7_mmul_writedata(gmem0_DDR_global_avm_writedata[0]),
      .mmul_0_avm_lm7_mmul_byteenable(gmem0_DDR_global_avm_byteenable[0]),
      .mmul_0_avm_lm7_mmul_waitrequest(gmem0_DDR_global_avm_waitrequest[0]),
      .mmul_0_avm_lm7_mmul_readdata(gmem0_DDR_global_avm_readdata[0]),
      .mmul_0_avm_lm7_mmul_readdatavalid(gmem0_DDR_global_avm_readdatavalid[0]),
      .mmul_0_avm_lm7_mmul_burstcount(gmem0_DDR_global_avm_burstcount[0]),
      .mmul_0_avm_lm7_mmul_writeack(gmem0_DDR_global_avm_writeack[0]),
      ...
      // AVM mmul_0_avm_unnamed_mmul5_mmul
      .mmul_0_avm_unnamed_mmul5_mmul_enable(gmem0_DDR_global_avm_enable[2]),
      .mmul_0_avm_unnamed_mmul5_mmul_read(gmem0_DDR_global_avm_read[2]),
      .mmul_0_avm_unnamed_mmul5_mmul_write(gmem0_DDR_global_avm_write[2]),
      .mmul_0_avm_unnamed_mmul5_mmul_address(gmem0_DDR_global_avm_address[2]),
      .mmul_0_avm_unnamed_mmul5_mmul_writedata(gmem0_DDR_global_avm_writedata[2]),
      .mmul_0_avm_unnamed_mmul5_mmul_byteenable(gmem0_DDR_global_avm_byteenable[2]),
      .mmul_0_avm_unnamed_mmul5_mmul_waitrequest(gmem0_DDR_global_avm_waitrequest[2]),
      .mmul_0_avm_unnamed_mmul5_mmul_readdata(gmem0_DDR_global_avm_readdata[2]),
      .mmul_0_avm_unnamed_mmul5_mmul_readdatavalid(gmem0_DDR_global_avm_readdatavalid[2]),
      .mmul_0_avm_unnamed_mmul5_mmul_burstcount(gmem0_DDR_global_avm_burstcount[2]),
      .mmul_0_avm_unnamed_mmul5_mmul_writeack(gmem0_DDR_global_avm_writeack[2])
   );
...
(
   ...
   // AVM mmul_0_avm_lm7_mmul
   output logic mmul_0_avm_lm7_mmul_enable,
   output logic mmul_0_avm_lm7_mmul_read,
   output logic mmul_0_avm_lm7_mmul_write,
   output logic [30:0] mmul_0_avm_lm7_mmul_address,
   output logic [511:0] mmul_0_avm_lm7_mmul_writedata,
   output logic [63:0] mmul_0_avm_lm7_mmul_byteenable,
   input logic mmul_0_avm_lm7_mmul_waitrequest,
   input logic [511:0] mmul_0_avm_lm7_mmul_readdata,
   input logic mmul_0_avm_lm7_mmul_readdatavalid,
   output logic [4:0] mmul_0_avm_lm7_mmul_burstcount,
   input logic mmul_0_avm_lm7_mmul_writeack,
   // AVM mmul_0_avm_lm_mmul
   ...
   // AVM mmul_0_avm_unnamed_mmul5_mmul
   output logic mmul_0_avm_unnamed_mmul5_mmul_enable,
   output logic mmul_0_avm_unnamed_mmul5_mmul_read,
   output logic mmul_0_avm_unnamed_mmul5_mmul_write,
   output logic [30:0] mmul_0_avm_unnamed_mmul5_mmul_address,
   output logic [511:0] mmul_0_avm_unnamed_mmul5_mmul_writedata,
   output logic [63:0] mmul_0_avm_unnamed_mmul5_mmul_byteenable,
   input logic mmul_0_avm_unnamed_mmul5_mmul_waitrequest,
   input logic [511:0] mmul_0_avm_unnamed_mmul5_mmul_readdata,
   input logic mmul_0_avm_unnamed_mmul5_mmul_readdatavalid,
   output logic [4:0] mmul_0_avm_unnamed_mmul5_mmul_burstcount,
   input logic mmul_0_avm_unnamed_mmul5_mmul_writeack
);
   logic mmul_start;
   ...
   logic [223:0] mmul_kernel_arguments;
   ...
   (
      ...
      .clock2x(clock2x),
      // AVM avm_lm7_mmul
      .avm_lm7_mmul_enable(mmul_0_avm_lm7_mmul_enable),
      .avm_lm7_mmul_read(mmul_0_avm_lm7_mmul_read),
      .avm_lm7_mmul_write(mmul_0_avm_lm7_mmul_write),
      .avm_lm7_mmul_address(mmul_0_avm_lm7_mmul_address),
      .avm_lm7_mmul_writedata(mmul_0_avm_lm7_mmul_writedata),
      .avm_lm7_mmul_byteenable(mmul_0_avm_lm7_mmul_byteenable),
      .avm_lm7_mmul_waitrequest(mmul_0_avm_lm7_mmul_waitrequest),
      .avm_lm7_mmul_readdata(mmul_0_avm_lm7_mmul_readdata),
      .avm_lm7_mmul_readdatavalid(mmul_0_avm_lm7_mmul_readdatavalid),
      .avm_lm7_mmul_burstcount(mmul_0_avm_lm7_mmul_burstcount),
      .avm_lm7_mmul_writeack(mmul_0_avm_lm7_mmul_writeack),
      // AVM avm_lm_mmul
      ...
      // AVM avm_unnamed_mmul5_mmul
      .avm_unnamed_mmul5_mmul_enable(mmul_0_avm_unnamed_mmul5_mmul_enable),
      .avm_unnamed_mmul5_mmul_read(mmul_0_avm_unnamed_mmul5_mmul_read),
      .avm_unnamed_mmul5_mmul_write(mmul_0_avm_unnamed_mmul5_mmul_write),
      .avm_unnamed_mmul5_mmul_address(mmul_0_avm_unnamed_mmul5_mmul_address),
      .avm_unnamed_mmul5_mmul_writedata(mmul_0_avm_unnamed_mmul5_mmul_writedata),
      .avm_unnamed_mmul5_mmul_byteenable(mmul_0_avm_unnamed_mmul5_mmul_byteenable),
      .avm_unnamed_mmul5_mmul_waitrequest(mmul_0_avm_unnamed_mmul5_mmul_waitrequest),
      .avm_unnamed_mmul5_mmul_readdata(mmul_0_avm_unnamed_mmul5_mmul_readdata),
      .avm_unnamed_mmul5_mmul_readdatavalid(mmul_0_avm_unnamed_mmul5_mmul_readdatavalid),
      .avm_unnamed_mmul5_mmul_burstcount(mmul_0_avm_unnamed_mmul5_mmul_burstcount),
      .avm_unnamed_mmul5_mmul_writeack(mmul_0_avm_unnamed_mmul5_mmul_writeack)
   );
...
(
   ...
   input logic clock2x,
   // AVM avm_lm7_mmul
   output logic avm_lm7_mmul_enable,
   output logic avm_lm7_mmul_read,
   output logic avm_lm7_mmul_write,
   output logic [30:0] avm_lm7_mmul_address,
   output logic [511:0] avm_lm7_mmul_writedata,
   output logic [63:0] avm_lm7_mmul_byteenable,
   input logic avm_lm7_mmul_waitrequest,
   input logic [511:0] avm_lm7_mmul_readdata,
   input logic avm_lm7_mmul_readdatavalid,
   output logic [4:0] avm_lm7_mmul_burstcount,
   input logic avm_lm7_mmul_writeack,
   // AVM avm_lm_mmul
   ...
   // AVM avm_unnamed_mmul5_mmul
   output logic avm_unnamed_mmul5_mmul_enable,
   output logic avm_unnamed_mmul5_mmul_read,
   output logic avm_unnamed_mmul5_mmul_write,
   output logic [30:0] avm_unnamed_mmul5_mmul_address,
   output logic [511:0] avm_unnamed_mmul5_mmul_writedata,
   output logic [63:0] avm_unnamed_mmul5_mmul_byteenable,
   input logic avm_unnamed_mmul5_mmul_waitrequest,
   input logic [511:0] avm_unnamed_mmul5_mmul_readdata,
   input logic avm_unnamed_mmul5_mmul_readdatavalid,
   output logic [4:0] avm_unnamed_mmul5_mmul_burstcount,
   input logic avm_unnamed_mmul5_mmul_writeack
);
   ...
   (
      ...
      .clock2x(clock2x),
      // AVM avm_lm7_mmul
      .avm_lm7_mmul_enable(avm_lm7_mmul_enable),
      .avm_lm7_mmul_read(avm_lm7_mmul_read),
      .avm_lm7_mmul_write(avm_lm7_mmul_write),
      .avm_lm7_mmul_address(avm_lm7_mmul_address),
      .avm_lm7_mmul_writedata(avm_lm7_mmul_writedata),
      .avm_lm7_mmul_byteenable(avm_lm7_mmul_byteenable),
      .avm_lm7_mmul_waitrequest(avm_lm7_mmul_waitrequest),
      .avm_lm7_mmul_readdata(avm_lm7_mmul_readdata),
      .avm_lm7_mmul_readdatavalid(avm_lm7_mmul_readdatavalid),
      .avm_lm7_mmul_burstcount(avm_lm7_mmul_burstcount),
      .avm_lm7_mmul_writeack(avm_lm7_mmul_writeack),
      // AVM avm_lm_mmul
      ...
      // AVM avm_unnamed_mmul5_mmul
      .avm_unnamed_mmul5_mmul_enable(avm_unnamed_mmul5_mmul_enable),
      .avm_unnamed_mmul5_mmul_read(avm_unnamed_mmul5_mmul_read),
      .avm_unnamed_mmul5_mmul_write(avm_unnamed_mmul5_mmul_write),
      .avm_unnamed_mmul5_mmul_address(avm_unnamed_mmul5_mmul_address),
      .avm_unnamed_mmul5_mmul_writedata(avm_unnamed_mmul5_mmul_writedata),
      .avm_unnamed_mmul5_mmul_byteenable(avm_unnamed_mmul5_mmul_byteenable),
      .avm_unnamed_mmul5_mmul_waitrequest(avm_unnamed_mmul5_mmul_waitrequest),
      .avm_unnamed_mmul5_mmul_readdata(avm_unnamed_mmul5_mmul_readdata),
      .avm_unnamed_mmul5_mmul_readdatavalid(avm_unnamed_mmul5_mmul_readdatavalid),
      .avm_unnamed_mmul5_mmul_burstcount(avm_unnamed_mmul5_mmul_burstcount),
      .avm_unnamed_mmul5_mmul_writeack(avm_unnamed_mmul5_mmul_writeack)
   );
...
(
   ...
   begin:gmem0_DDR_
      ...
      // INST global_ic_preroutegmem0_DDR_router_0 of Simple_taskV4_sys_ic_18004512899439049807
      Simple_taskV4_sys_ic_18004512899439049807 global_ic_preroutegmem0_DDR_router_0
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
      ...
      // INST global_ic_preroutegmem0_DDR_router_1 of Simple_taskV4_sys_ic_18004512899439049807
      Simple_taskV4_sys_ic_18004512899439049807 global_ic_preroutegmem0_DDR_router_1
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
      ...
      // INST global_ic_preroutegmem0_DDR_router_2 of Simple_taskV4_sys_ic_10753627231702743408
      Simple_taskV4_sys_ic_10753627231702743408 global_ic_preroutegmem0_DDR_router_2
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
      ...
      // INST global_icgmem0_DDR_port_0_0_rw of Simple_taskV4_sys_ic_6838037962186751581
      Simple_taskV4_sys_ic_6838037962186751581 global_icgmem0_DDR_port_0_0_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE Simple_taskV4_sys_ic_18004512899439049807
/////////////////////////////////////////////////////////////////
module Simple_taskV4_sys_ic_18004512899439049807
(
   input logic clock,
...
/////////////////////////////////////////////////////////////////
// MODULE Simple_taskV4_sys_ic_10753627231702743408
/////////////////////////////////////////////////////////////////
module Simple_taskV4_sys_ic_10753627231702743408
(
   input logic clock,
...
/////////////////////////////////////////////////////////////////
// MODULE Simple_taskV4_sys_ic_6838037962186751581
/////////////////////////////////////////////////////////////////
module Simple_taskV4_sys_ic_6838037962186751581
(
   input logic clock,
