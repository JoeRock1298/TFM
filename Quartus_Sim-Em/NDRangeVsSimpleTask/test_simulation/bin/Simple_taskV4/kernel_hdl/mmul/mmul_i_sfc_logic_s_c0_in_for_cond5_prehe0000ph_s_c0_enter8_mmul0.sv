...
module mmul_i_sfc_logic_s_c0_in_for_cond5_prehe0000ph_s_c0_enter8_mmul0 (
    ...
    wire [33:0] i_fpga_indvars_iv_next19_mmul15_a;
    wire [33:0] i_fpga_indvars_iv_next19_mmul15_b;
    logic [33:0] i_fpga_indvars_iv_next19_mmul15_o;
    wire [33:0] i_fpga_indvars_iv_next19_mmul15_q;
    wire [32:0] i_inc23_mmul17_a;
    wire [32:0] i_inc23_mmul17_b;
    logic [32:0] i_inc23_mmul17_o;
    wire [32:0] i_inc23_mmul17_q;
    wire [0:0] i_llvm_fpga_ffwd_dest_i1_cmp286_mmul11_out_dest_data_out_0_0;
    ...
    wire [31:0] i_llvm_fpga_pop_i32_i_029_pop8_mmul7_out_data_out;
    wire [0:0] i_llvm_fpga_pop_i32_i_029_pop8_mmul7_out_feedback_stall_out_8;
    wire [32:0] i_llvm_fpga_pop_i33_fpga_indvars_iv18_pop7_mmul4_out_data_out;
    wire [0:0] i_llvm_fpga_pop_i33_fpga_indvars_iv18_pop7_mmul4_out_feedback_stall_out_7;
    ...
    wire [31:0] i_llvm_fpga_push_i32_i_029_push8_mmul18_out_feedback_out_8;
    wire [0:0] i_llvm_fpga_push_i32_i_029_push8_mmul18_out_feedback_valid_out_8;
    wire [63:0] i_llvm_fpga_push_i33_fpga_indvars_iv18_push7_mmul16_out_feedback_out_7;
    wire [0:0] i_llvm_fpga_push_i33_fpga_indvars_iv18_push7_mmul16_out_feedback_valid_out_7;
    ...
    wire [32:0] bgTrunc_i_fpga_indvars_iv_next19_mmul15_sel_x_b;
    wire [31:0] bgTrunc_i_inc23_mmul17_sel_x_b;
    ...
    wire [0:0] i_exitcond20_mmul9_cmp_nsign_q;
    ...
    // i_fpga_indvars_iv_next19_mmul15(ADD,24)@1
    assign i_fpga_indvars_iv_next19_mmul15_a = {1'b0, i_fpga_indvars_iv18_replace_phi_mmul5_q};
    assign i_fpga_indvars_iv_next19_mmul15_b = {1'b0, c_i33_133_q};
    assign i_fpga_indvars_iv_next19_mmul15_o = $unsigned(i_fpga_indvars_iv_next19_mmul15_a) + $unsigned(i_fpga_indvars_iv_next19_mmul15_b);
    assign i_fpga_indvars_iv_next19_mmul15_q = i_fpga_indvars_iv_next19_mmul15_o[33:0];

    // bgTrunc_i_fpga_indvars_iv_next19_mmul15_sel_x(BITSELECT,45)@1
    assign bgTrunc_i_fpga_indvars_iv_next19_mmul15_sel_x_b = i_fpga_indvars_iv_next19_mmul15_q[32:0];

    // i_llvm_fpga_push_i33_fpga_indvars_iv18_push7_mmul16(BLACKBOX,33)@1
    // out out_feedback_out_7@20000000
    // out out_feedback_valid_out_7@20000000
    mmul_i_llvm_fpga_push_i33_fpga_indvars_iv18_push7_0 thei_llvm_fpga_push_i33_fpga_indvars_iv18_push7_mmul16 (
        .in_data_in(bgTrunc_i_fpga_indvars_iv_next19_mmul15_sel_x_b),
        .in_feedback_stall_in_7(i_llvm_fpga_pop_i33_fpga_indvars_iv18_pop7_mmul4_out_feedback_stall_out_7),
        .in_stall_in(GND_q),
        .in_unnamed_mmul7(i_unnamed_mmul12_q),
        .in_valid_in(in_i_valid),
        .out_data_out(),
        .out_feedback_out_7(i_llvm_fpga_push_i33_fpga_indvars_iv18_push7_mmul16_out_feedback_out_7),
        .out_feedback_valid_out_7(i_llvm_fpga_push_i33_fpga_indvars_iv18_push7_mmul16_out_feedback_valid_out_7),
        .out_stall_out(),
        .out_valid_out(),
        .clock(clock),
        .resetn(resetn)
    ...
    // i_llvm_fpga_pop_i33_fpga_indvars_iv18_pop7_mmul4(BLACKBOX,30)@1
    // out out_feedback_stall_out_7@20000000
    mmul_i_llvm_fpga_pop_i33_fpga_indvars_iv18_pop7_0 thei_llvm_fpga_pop_i33_fpga_indvars_iv18_pop7_mmul4 (
        .in_data_in(c_i33_undef30_q),
        .in_dir(in_c0_eni1_1_tpl),
        .in_feedback_in_7(i_llvm_fpga_push_i33_fpga_indvars_iv18_push7_mmul16_out_feedback_out_7),
        .in_feedback_valid_in_7(i_llvm_fpga_push_i33_fpga_indvars_iv18_push7_mmul16_out_feedback_valid_out_7),
        .in_predicate(GND_q),
        .in_stall_in(GND_q),
        .in_valid_in(in_i_valid),
        .out_data_out(i_llvm_fpga_pop_i33_fpga_indvars_iv18_pop7_mmul4_out_data_out),
        .out_feedback_stall_out_7(i_llvm_fpga_pop_i33_fpga_indvars_iv18_pop7_mmul4_out_feedback_stall_out_7),
        .out_stall_out(),
        .out_valid_out(),
        .clock(clock),
        .resetn(resetn)
    ...
    // i_fpga_indvars_iv18_replace_phi_mmul5(MUX,23)@1
    assign i_fpga_indvars_iv18_replace_phi_mmul5_s = in_c0_eni1_1_tpl;
    always @(i_fpga_indvars_iv18_replace_phi_mmul5_s or i_llvm_fpga_pop_i33_fpga_indvars_iv18_pop7_mmul4_out_data_out or i_llvm_fpga_ffwd_dest_i33_unnamed_mmul2_mmul3_out_dest_data_out_1_0)
    begin
        unique case (i_fpga_indvars_iv18_replace_phi_mmul5_s)
            1'b0 : i_fpga_indvars_iv18_replace_phi_mmul5_q = i_llvm_fpga_pop_i33_fpga_indvars_iv18_pop7_mmul4_out_data_out;
            1'b1 : i_fpga_indvars_iv18_replace_phi_mmul5_q = i_llvm_fpga_ffwd_dest_i33_unnamed_mmul2_mmul3_out_dest_data_out_1_0;
            default : i_fpga_indvars_iv18_replace_phi_mmul5_q = 33'b0;
        endcase
    end

    // i_exitcond20_mmul9_cmp_nsign(LOGICAL,59)@1
    assign i_exitcond20_mmul9_cmp_nsign_q = $unsigned(~ (i_fpga_indvars_iv18_replace_phi_mmul5_q[32:32]));

    // i_llvm_fpga_ffwd_dest_i1_cmp286_mmul11(BLACKBOX,26)@1
    mmul_i_llvm_fpga_ffwd_dest_i1_cmp286_0 thei_llvm_fpga_ffwd_dest_i1_cmp286_mmul11 (
        .in_intel_reserved_ffwd_0_0(in_intel_reserved_ffwd_0_0),
        .in_stall_in(GND_q),
        .in_valid_in(in_i_valid),
        .out_dest_data_out_0_0(i_llvm_fpga_ffwd_dest_i1_cmp286_mmul11_out_dest_data_out_0_0),
        .out_stall_out(),
        .out_valid_out(),
        .clock(clock),
        .resetn(resetn)
    ...
    assign i_unnamed_mmul12_q = i_llvm_fpga_ffwd_dest_i1_cmp286_mmul11_out_dest_data_out_0_0 & i_exitcond20_mmul9_cmp_nsign_q;
    ...
    // i_inc23_mmul17(ADD,25)@2
    assign i_inc23_mmul17_a = {1'b0, i_llvm_fpga_pop_i32_i_029_pop8_mmul7_out_data_out};
    assign i_inc23_mmul17_b = {1'b0, c_i32_134_q};
    assign i_inc23_mmul17_o = $unsigned(i_inc23_mmul17_a) + $unsigned(i_inc23_mmul17_b);
    assign i_inc23_mmul17_q = i_inc23_mmul17_o[32:0];

    // bgTrunc_i_inc23_mmul17_sel_x(BITSELECT,46)@2
    assign bgTrunc_i_inc23_mmul17_sel_x_b = i_inc23_mmul17_q[31:0];

    // i_llvm_fpga_push_i32_i_029_push8_mmul18(BLACKBOX,32)@2
    // out out_feedback_out_8@20000000
    // out out_feedback_valid_out_8@20000000
    mmul_i_llvm_fpga_push_i32_i_029_push8_0 thei_llvm_fpga_push_i32_i_029_push8_mmul18 (
        .in_data_in(bgTrunc_i_inc23_mmul17_sel_x_b),
        .in_feedback_stall_in_8(i_llvm_fpga_pop_i32_i_029_pop8_mmul7_out_feedback_stall_out_8),
        .in_stall_in(GND_q),
        .in_unnamed_mmul7(redist2_i_unnamed_mmul12_q_1_q),
        .in_valid_in(valid_fanout_reg3_q),
        .out_data_out(),
        .out_feedback_out_8(i_llvm_fpga_push_i32_i_029_push8_mmul18_out_feedback_out_8),
        .out_feedback_valid_out_8(i_llvm_fpga_push_i32_i_029_push8_mmul18_out_feedback_valid_out_8),
        .out_stall_out(),
        .out_valid_out(),
        .clock(clock),
        .resetn(resetn)
    ...
    // i_llvm_fpga_pop_i32_i_029_pop8_mmul7(BLACKBOX,29)@2
    // out out_feedback_stall_out_8@20000000
    mmul_i_llvm_fpga_pop_i32_i_029_pop8_0 thei_llvm_fpga_pop_i32_i_029_pop8_mmul7 (
        .in_data_in(c_i32_031_q),
        .in_dir(redist0_sync_together47_aunroll_x_in_c0_eni1_1_tpl_1_q),
        .in_feedback_in_8(i_llvm_fpga_push_i32_i_029_push8_mmul18_out_feedback_out_8),
        .in_feedback_valid_in_8(i_llvm_fpga_push_i32_i_029_push8_mmul18_out_feedback_valid_out_8),
        .in_predicate(GND_q),
        .in_stall_in(GND_q),
        .in_valid_in(valid_fanout_reg2_q),
        .out_data_out(i_llvm_fpga_pop_i32_i_029_pop8_mmul7_out_data_out),
        .out_feedback_stall_out_8(i_llvm_fpga_pop_i32_i_029_pop8_mmul7_out_feedback_stall_out_8),
        .out_stall_out(),
        .out_valid_out(),
        .clock(clock),
        .resetn(resetn)
    ...
    assign i_mul_mmul8_bs1_merged_bit_select_b = i_llvm_fpga_pop_i32_i_029_pop8_mmul7_out_data_out[31:18];
    assign i_mul_mmul8_bs1_merged_bit_select_c = i_llvm_fpga_pop_i32_i_029_pop8_mmul7_out_data_out[17:0];
