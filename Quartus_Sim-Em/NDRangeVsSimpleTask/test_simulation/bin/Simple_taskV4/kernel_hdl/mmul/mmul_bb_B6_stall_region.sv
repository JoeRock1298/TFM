...
module mmul_bb_B6_stall_region (
    ...
    input wire [31:0] in_j_026_pop1033,
    ...
    assign bubble_join_stall_entry_q = {in_notcmp1631, in_notcmp1622_pop1235, in_notcmp1232, in_mul28, in_mul20_pop1134, in_j_026_pop1033, in_forked10};
