...
module mmul_bb_B4 (
    ...
    wire [0:0] bb_mmul_B4_stall_region_out_c0_exe104;
    ...
    wire [0:0] mmul_B4_merge_out_c0_exe104;
    ...
    // mmul_B4_branch(BLACKBOX,11)
    mmul_B4_branch themmul_B4_branch (
        .in_c0_exe104(bb_mmul_B4_stall_region_out_c0_exe104),
    ...
    mmul_bb_B4_stall_region thebb_mmul_B4_stall_region (
        .in_c0_exe104(mmul_B4_merge_out_c0_exe104),
        .in_stall_in(mmul_B4_branch_out_stall_out),
        .in_valid_in(mmul_B4_merge_out_valid_out),
        .out_c0_exe104(bb_mmul_B4_stall_region_out_c0_exe104),
    ...
    // mmul_B4_merge(BLACKBOX,12)
    mmul_B4_merge themmul_B4_merge (
        .in_c0_exe104_0(in_c0_exe104_0),
        .in_stall_in(bb_mmul_B4_stall_region_out_stall_out),
        .in_valid_in_0(in_valid_in_0),
        .out_c0_exe104(mmul_B4_merge_out_c0_exe104),
