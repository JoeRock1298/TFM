...
module mmul_i_sfc_logic_s_c0_in_for_body8_preheader_s_c0_enter439_mmul0 (
    ...
    wire [0:0] i_fpga_indvars_iv15_replace_phi_mmul5_s;
    reg [32:0] i_fpga_indvars_iv15_replace_phi_mmul5_q;
    wire [33:0] i_fpga_indvars_iv_next16_mmul12_a;
    wire [33:0] i_fpga_indvars_iv_next16_mmul12_b;
    logic [33:0] i_fpga_indvars_iv_next16_mmul12_o;
    wire [33:0] i_fpga_indvars_iv_next16_mmul12_q;
    wire [32:0] i_inc20_mmul15_a;
    wire [32:0] i_inc20_mmul15_b;
    logic [32:0] i_inc20_mmul15_o;
    wire [32:0] i_inc20_mmul15_q;
    wire [0:0] i_llvm_fpga_ffwd_dest_i1_cmp287_mmul8_out_dest_data_out_0_0;
    ...
    wire [31:0] i_llvm_fpga_pop_i32_j_026_pop10_mmul14_out_data_out;
    wire [0:0] i_llvm_fpga_pop_i32_j_026_pop10_mmul14_out_feedback_stall_out_10;
    ...
    wire [32:0] i_llvm_fpga_pop_i33_fpga_indvars_iv15_pop9_mmul4_out_data_out;
    wire [0:0] i_llvm_fpga_pop_i33_fpga_indvars_iv15_pop9_mmul4_out_feedback_stall_out_9;
    ...
    wire [31:0] i_llvm_fpga_push_i32_j_026_push10_mmul16_out_feedback_out_10;
    wire [0:0] i_llvm_fpga_push_i32_j_026_push10_mmul16_out_feedback_valid_out_10;
    ...
    wire [63:0] i_llvm_fpga_push_i33_fpga_indvars_iv15_push9_mmul13_out_feedback_out_9;
    wire [0:0] i_llvm_fpga_push_i33_fpga_indvars_iv15_push9_mmul13_out_feedback_valid_out_9;
    wire [0:0] i_notcmp12_mmul10_q;
    wire [0:0] i_unnamed_mmul9_q;
    wire [32:0] bgTrunc_i_fpga_indvars_iv_next16_mmul12_sel_x_b;
    wire [31:0] bgTrunc_i_inc20_mmul15_sel_x_b;
    ...
    wire [0:0] i_exitcond17_mmul6_cmp_nsign_q;
    ...
    // i_fpga_indvars_iv_next16_mmul12(ADD,26)@1
    assign i_fpga_indvars_iv_next16_mmul12_a = {1'b0, i_fpga_indvars_iv15_replace_phi_mmul5_q};
    assign i_fpga_indvars_iv_next16_mmul12_b = {1'b0, c_i33_137_q};
    assign i_fpga_indvars_iv_next16_mmul12_o = $unsigned(i_fpga_indvars_iv_next16_mmul12_a) + $unsigned(i_fpga_indvars_iv_next16_mmul12_b);
    assign i_fpga_indvars_iv_next16_mmul12_q = i_fpga_indvars_iv_next16_mmul12_o[33:0];

    // bgTrunc_i_fpga_indvars_iv_next16_mmul12_sel_x(BITSELECT,48)@1
    assign bgTrunc_i_fpga_indvars_iv_next16_mmul12_sel_x_b = i_fpga_indvars_iv_next16_mmul12_q[32:0];

    // i_llvm_fpga_push_i33_fpga_indvars_iv15_push9_mmul13(BLACKBOX,39)@1
    // out out_feedback_out_9@20000000
    // out out_feedback_valid_out_9@20000000
    mmul_i_llvm_fpga_push_i33_fpga_indvars_iv15_push9_0 thei_llvm_fpga_push_i33_fpga_indvars_iv15_push9_mmul13 (
        .in_data_in(bgTrunc_i_fpga_indvars_iv_next16_mmul12_sel_x_b),
        .in_feedback_stall_in_9(i_llvm_fpga_pop_i33_fpga_indvars_iv15_pop9_mmul4_out_feedback_stall_out_9),
        .in_stall_in(GND_q),
        .in_unnamed_mmul8(i_unnamed_mmul9_q),
        .in_valid_in(in_i_valid),
        .out_data_out(),
        .out_feedback_out_9(i_llvm_fpga_push_i33_fpga_indvars_iv15_push9_mmul13_out_feedback_out_9),
        .out_feedback_valid_out_9(i_llvm_fpga_push_i33_fpga_indvars_iv15_push9_mmul13_out_feedback_valid_out_9),
        .out_stall_out(),
        .out_valid_out(),
        .clock(clock),
        .resetn(resetn)
    ...
    // i_llvm_fpga_pop_i33_fpga_indvars_iv15_pop9_mmul4(BLACKBOX,34)@1
    // out out_feedback_stall_out_9@20000000
    mmul_i_llvm_fpga_pop_i33_fpga_indvars_iv15_pop9_0 thei_llvm_fpga_pop_i33_fpga_indvars_iv15_pop9_mmul4 (
        .in_data_in(c_i33_undef35_q),
        .in_dir(in_c0_eni3_1_tpl),
        .in_feedback_in_9(i_llvm_fpga_push_i33_fpga_indvars_iv15_push9_mmul13_out_feedback_out_9),
        .in_feedback_valid_in_9(i_llvm_fpga_push_i33_fpga_indvars_iv15_push9_mmul13_out_feedback_valid_out_9),
        .in_predicate(GND_q),
        .in_stall_in(GND_q),
        .in_valid_in(in_i_valid),
        .out_data_out(i_llvm_fpga_pop_i33_fpga_indvars_iv15_pop9_mmul4_out_data_out),
        .out_feedback_stall_out_9(i_llvm_fpga_pop_i33_fpga_indvars_iv15_pop9_mmul4_out_feedback_stall_out_9),
        .out_stall_out(),
        .out_valid_out(),
        .clock(clock),
        .resetn(resetn)
    ...
    // i_fpga_indvars_iv15_replace_phi_mmul5(MUX,25)@1
    assign i_fpga_indvars_iv15_replace_phi_mmul5_s = in_c0_eni3_1_tpl;
    always @(i_fpga_indvars_iv15_replace_phi_mmul5_s or i_llvm_fpga_pop_i33_fpga_indvars_iv15_pop9_mmul4_out_data_out or i_llvm_fpga_ffwd_dest_i33_unnamed_mmul4_mmul3_out_dest_data_out_1_0)
    begin
        unique case (i_fpga_indvars_iv15_replace_phi_mmul5_s)
            1'b0 : i_fpga_indvars_iv15_replace_phi_mmul5_q = i_llvm_fpga_pop_i33_fpga_indvars_iv15_pop9_mmul4_out_data_out;
            1'b1 : i_fpga_indvars_iv15_replace_phi_mmul5_q = i_llvm_fpga_ffwd_dest_i33_unnamed_mmul4_mmul3_out_dest_data_out_1_0;
            default : i_fpga_indvars_iv15_replace_phi_mmul5_q = 33'b0;
        endcase
    end

    // i_exitcond17_mmul6_cmp_nsign(LOGICAL,63)@1
    assign i_exitcond17_mmul6_cmp_nsign_q = $unsigned(~ (i_fpga_indvars_iv15_replace_phi_mmul5_q[32:32]));

    // i_llvm_fpga_ffwd_dest_i1_cmp287_mmul8(BLACKBOX,28)@1
    mmul_i_llvm_fpga_ffwd_dest_i1_cmp287_0 thei_llvm_fpga_ffwd_dest_i1_cmp287_mmul8 (
        .in_intel_reserved_ffwd_0_0(in_intel_reserved_ffwd_0_0),
        .in_stall_in(GND_q),
        .in_valid_in(in_i_valid),
        .out_dest_data_out_0_0(i_llvm_fpga_ffwd_dest_i1_cmp287_mmul8_out_dest_data_out_0_0),
        .out_stall_out(),
        .out_valid_out(),
        .clock(clock),
        .resetn(resetn)
    ...
    assign i_unnamed_mmul9_q = i_llvm_fpga_ffwd_dest_i1_cmp287_mmul8_out_dest_data_out_0_0 & i_exitcond17_mmul6_cmp_nsign_q;
    ...
    // i_inc20_mmul15(ADD,27)@2
    assign i_inc20_mmul15_a = {1'b0, i_llvm_fpga_pop_i32_j_026_pop10_mmul14_out_data_out};
    assign i_inc20_mmul15_b = {1'b0, c_i32_139_q};
    assign i_inc20_mmul15_o = $unsigned(i_inc20_mmul15_a) + $unsigned(i_inc20_mmul15_b);
    assign i_inc20_mmul15_q = i_inc20_mmul15_o[32:0];

    // bgTrunc_i_inc20_mmul15_sel_x(BITSELECT,49)@2
    assign bgTrunc_i_inc20_mmul15_sel_x_b = i_inc20_mmul15_q[31:0];

    // i_llvm_fpga_push_i32_j_026_push10_mmul16(BLACKBOX,37)@2
    // out out_feedback_out_10@20000000
    // out out_feedback_valid_out_10@20000000
    mmul_i_llvm_fpga_push_i32_j_026_push10_0 thei_llvm_fpga_push_i32_j_026_push10_mmul16 (
        .in_data_in(bgTrunc_i_inc20_mmul15_sel_x_b),
        .in_feedback_stall_in_10(i_llvm_fpga_pop_i32_j_026_pop10_mmul14_out_feedback_stall_out_10),
        .in_stall_in(GND_q),
        .in_unnamed_mmul8(redist3_i_unnamed_mmul9_q_1_q),
        .in_valid_in(valid_fanout_reg2_q),
        .out_data_out(),
        .out_feedback_out_10(i_llvm_fpga_push_i32_j_026_push10_mmul16_out_feedback_out_10),
        .out_feedback_valid_out_10(i_llvm_fpga_push_i32_j_026_push10_mmul16_out_feedback_valid_out_10),
        .out_stall_out(),
        .out_valid_out(),
        .clock(clock),
        .resetn(resetn)
    ...
    // i_llvm_fpga_pop_i32_j_026_pop10_mmul14(BLACKBOX,32)@2
    // out out_feedback_stall_out_10@20000000
    mmul_i_llvm_fpga_pop_i32_j_026_pop10_0 thei_llvm_fpga_pop_i32_j_026_pop10_mmul14 (
        .in_data_in(c_i32_038_q),
        .in_dir(redist0_sync_together55_aunroll_x_in_c0_eni3_1_tpl_1_q),
        .in_feedback_in_10(i_llvm_fpga_push_i32_j_026_push10_mmul16_out_feedback_out_10),
        .in_feedback_valid_in_10(i_llvm_fpga_push_i32_j_026_push10_mmul16_out_feedback_valid_out_10),
        .in_predicate(GND_q),
        .in_stall_in(GND_q),
        .in_valid_in(valid_fanout_reg1_q),
        .out_data_out(i_llvm_fpga_pop_i32_j_026_pop10_mmul14_out_data_out),
        .out_feedback_stall_out_10(i_llvm_fpga_pop_i32_j_026_pop10_mmul14_out_feedback_stall_out_10),
        .out_stall_out(),
        .out_valid_out(),
        .clock(clock),
        .resetn(resetn)
    ...
    assign out_c0_exi7_3_tpl = i_llvm_fpga_pop_i32_j_026_pop10_mmul14_out_data_out;
