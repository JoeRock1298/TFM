...
module mmul_B6_merge (
    ...
    input wire [31:0] in_j_026_pop1033_0,
    input wire [31:0] in_j_026_pop1033_1,
    ...
    output wire [31:0] out_j_026_pop1033,
    ...
    wire [0:0] j_026_pop1033_mux_s;
    reg [31:0] j_026_pop1033_mux_q;
    ...
    // j_026_pop1033_mux(MUX,20)
    assign j_026_pop1033_mux_s = in_valid_in_0;
    always @(j_026_pop1033_mux_s or in_j_026_pop1033_1 or in_j_026_pop1033_0)
    begin
        unique case (j_026_pop1033_mux_s)
            1'b0 : j_026_pop1033_mux_q = in_j_026_pop1033_1;
            1'b1 : j_026_pop1033_mux_q = in_j_026_pop1033_0;
            default : j_026_pop1033_mux_q = 32'b0;
        endcase
    end

    // out_j_026_pop1033(GPOUT,27)
    assign out_j_026_pop1033 = j_026_pop1033_mux_q;
