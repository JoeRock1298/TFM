...
module mmul_B3_branch (
    input wire [0:0] in_c0_exe250,
    input wire [31:0] in_c0_exe351,
    ...
    // out_c0_exe250(GPOUT,10)
    assign out_c0_exe250 = in_c0_exe250;

    // out_c0_exe351(GPOUT,11)
    assign out_c0_exe351 = in_c0_exe351;
