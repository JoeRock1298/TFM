...
module mmul_bb_B5_stall_region (
    ...
    reg [0:0] SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_R_v_2;
    ...
    wire [0:0] SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_s_tv_2;
    wire [0:0] SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_backEN;
    wire [0:0] SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_or0;
    wire [0:0] SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_or1;
    ...
    wire [0:0] SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_V2;
    ...
    // Determine whether to write valid data into the first register stage
    assign SE_coalesced_delay_1_1_v_s_0 = SE_coalesced_delay_1_1_backEN & SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_V0;
    // Backward Stall generation
    ...
    // Backward Stall generation
    assign SE_stall_entry_backStall = SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_backStall | ~ (SE_stall_entry_wireValid);
    // Computing multiple Valid(s)
    assign SE_stall_entry_wireValid = in_valid_in;

    // SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0(STALLENABLE,88)
    // Valid signal propagation
    ...
    assign SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_V2 = SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_R_v_2;
    // Stall signal propagation
    assign SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_s_tv_0 = SE_coalesced_delay_1_1_backStall & SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_R_v_0;
    assign SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_s_tv_1 = SE_out_i_llvm_fpga_sync_buffer_p1024f32_c_sync_buffer_mmul2_backStall & SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_R_v_1;
    assign SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_s_tv_2 = i_llvm_fpga_sync_buffer_p1024f32_c_sync_buffer_mmul2_out_stall_out & SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_R_v_2;
    // Backward Enable generation
    assign SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_or0 = SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_s_tv_0;
    assign SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_or1 = SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_s_tv_1 | SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_or0;
    assign SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_backEN = ~ (SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_s_tv_2 | SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_or1);
    // Determine whether to write valid data into the first register stage
    ...
    begin
        ...
        begin
            ...
            SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_R_v_2 <= 1'b0;
        end
        else
        begin
            ...
            if (SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_backEN == 1'b0)
            begin
                SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_R_v_2 <= SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_R_v_2 & SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_s_tv_2;
            end
            else
            begin
                SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_R_v_2 <= SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_v_s_0;
            end
    ...
    mmul_i_llvm_fpga_sync_buffer_p1024f32_c_sync_buffer_0 thei_llvm_fpga_sync_buffer_p1024f32_c_sync_buffer_mmul2 (
        ...
        .in_valid_in(SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_V2),
    ...
    assign SE_out_i_llvm_fpga_sync_buffer_p1024f32_c_sync_buffer_mmul2_wireValid = SE_redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0_V1 & SE_out_i_llvm_fpga_sync_buffer_p1024f32_c_sync_buffer_mmul2_and0;
    ...
    // i_add15_mmul0(ADD,8)@0
    assign i_add15_mmul0_a = {1'b0, bubble_select_stall_entry_f};
    assign i_add15_mmul0_b = {1'b0, bubble_select_stall_entry_e};
    assign i_add15_mmul0_o = $unsigned(i_add15_mmul0_a) + $unsigned(i_add15_mmul0_b);
    assign i_add15_mmul0_q = i_add15_mmul0_o[32:0];

    // bgTrunc_i_add15_mmul0_sel_x(BITSELECT,31)@0
    assign bgTrunc_i_add15_mmul0_sel_x_b = i_add15_mmul0_q[31:0];

    // redist0_bgTrunc_i_add15_mmul0_sel_x_b_1_0(REG,54)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // i_idxprom16_mmul1_sel_x(BITSELECT,40)@1
    ...
    // i_arrayidx173_mmul0_narrow_x(BITSELECT,36)@1
    assign i_arrayidx173_mmul0_narrow_x_b = i_idxprom16_mmul1_sel_x_b[61:0];

    // i_arrayidx173_mmul0_shift_join_x(BITJOIN,37)@1
    ...
    // i_arrayidx173_mmul0_add_x(ADD,34)@1
