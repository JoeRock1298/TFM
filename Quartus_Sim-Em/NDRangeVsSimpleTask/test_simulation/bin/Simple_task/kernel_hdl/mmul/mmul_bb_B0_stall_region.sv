...
module mmul_bb_B0_stall_region (
    ...
    wire [33:0] i_cmp27_mmul2_a;
    wire [33:0] i_cmp27_mmul2_b;
    logic [33:0] i_cmp27_mmul2_o;
    wire [0:0] i_cmp27_mmul2_c;
    ...
    // i_cmp27_mmul2(COMPARE,15)@1
    assign i_cmp27_mmul2_a = $unsigned({{2{c_i32_016_recast_x_q[31]}}, c_i32_016_recast_x_q});
    assign i_cmp27_mmul2_b = $unsigned({{2{bubble_select_i_llvm_fpga_sync_buffer_i32_n_sync_buffer_mmul1_b[31]}}, bubble_select_i_llvm_fpga_sync_buffer_i32_n_sync_buffer_mmul1_b});
    assign i_cmp27_mmul2_o = $unsigned($signed(i_cmp27_mmul2_a) - $signed(i_cmp27_mmul2_b));
    assign i_cmp27_mmul2_c[0] = i_cmp27_mmul2_o[33];
    ...
    mmul_i_llvm_fpga_ffwd_source_i1_unnamed_0_mmul0 thei_llvm_fpga_ffwd_source_i1_unnamed_mmul0_mmul12 (
        .in_predicate_in(GND_q),
        .in_src_data_in_0_0(i_cmp27_mmul2_c),
