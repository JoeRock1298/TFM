...
module mmul_B4_branch (
    ...
    // mmul_B4_branch_enable(LOGICAL,13)
    ...
    begin
        if (!resetn)
        begin
            c0_exe233_reg_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (mmul_B4_branch_enable_q == 1'b1)
        begin
            c0_exe233_reg_q <= in_c0_exe233;
        end
    end

    // out_c0_exe233(GPOUT,21)
    assign out_c0_exe233 = c0_exe233_reg_q;
    ...
    // mmul_B4_branch_enable_not(LOGICAL,14)
