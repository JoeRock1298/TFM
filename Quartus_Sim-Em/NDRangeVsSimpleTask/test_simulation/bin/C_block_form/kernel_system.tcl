...
add_instance C_block_form_sys C_block_form_sys

add_connection clk_1x.out_clk C_block_form_sys.clock_reset
add_connection clk_2x.out_clk C_block_form_sys.clock_reset2x
add_connection reset.out_reset C_block_form_sys.clock_reset_reset

add_interface kernel_mem0 avalon slave
set_interface_property kernel_mem0 EXPORT_OF C_block_form_sys.avm_mem_gmem0_DDR_port_0_0_rw
...
add_connection kernel_irq.receiver_irq C_block_form_sys.kernel_irq
...
add_connection kernel_cra.m0 C_block_form_sys.cra_ring_root_avs
set_connection_parameter_value kernel_cra.m0/C_block_form_sys.cra_ring_root_avs baseAddress "0x0"
