...
// SystemVerilog created from mmul_B0_merge
...
module mmul_B0_merge (
    ...
    output wire [31:0] out_acl_group_id_0,
    output wire [31:0] out_acl_group_id_1,
    output wire [31:0] out_acl_local_id_0,
    output wire [31:0] out_acl_local_id_1,
    ...
    // out_acl_global_id_1(GPOUT,11)
    assign out_acl_global_id_1 = in_acl_global_id_1_0;

    // out_acl_group_id_0(GPOUT,12)
    assign out_acl_group_id_0 = in_acl_group_id_0_0;

    // out_acl_group_id_1(GPOUT,13)
    assign out_acl_group_id_1 = in_acl_group_id_1_0;

    // out_acl_local_id_0(GPOUT,14)
    assign out_acl_local_id_0 = in_acl_local_id_0_0;

    // out_acl_local_id_1(GPOUT,15)
    assign out_acl_local_id_1 = in_acl_local_id_1_0;
