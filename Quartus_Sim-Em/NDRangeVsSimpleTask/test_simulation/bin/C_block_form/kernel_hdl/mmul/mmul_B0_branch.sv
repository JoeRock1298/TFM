...
// SystemVerilog created from mmul_B0_branch
...
module mmul_B0_branch (
    ...
    // out_acl_global_id_0(GPOUT,16)
    assign out_acl_global_id_0 = in_acl_global_id_0;

    // out_acl_global_id_1(GPOUT,17)
    assign out_acl_global_id_1 = in_acl_global_id_1;

    // out_acl_local_id_0(GPOUT,18)
    assign out_acl_local_id_0 = in_acl_local_id_0;
