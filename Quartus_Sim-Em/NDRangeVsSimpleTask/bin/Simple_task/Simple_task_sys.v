...
(
   ...
   (
      ...
      // AVM mmul_0_avm_memdep_mmul
      .mmul_0_avm_memdep_mmul_enable(gmem0_DDR_global_avm_enable[2]),
      .mmul_0_avm_memdep_mmul_read(gmem0_DDR_global_avm_read[2]),
      .mmul_0_avm_memdep_mmul_write(gmem0_DDR_global_avm_write[2]),
      .mmul_0_avm_memdep_mmul_address(gmem0_DDR_global_avm_address[2]),
      .mmul_0_avm_memdep_mmul_writedata(gmem0_DDR_global_avm_writedata[2]),
      .mmul_0_avm_memdep_mmul_byteenable(gmem0_DDR_global_avm_byteenable[2]),
      .mmul_0_avm_memdep_mmul_waitrequest(gmem0_DDR_global_avm_waitrequest[2]),
      .mmul_0_avm_memdep_mmul_readdata(gmem0_DDR_global_avm_readdata[2]),
      .mmul_0_avm_memdep_mmul_readdatavalid(gmem0_DDR_global_avm_readdatavalid[2]),
      .mmul_0_avm_memdep_mmul_burstcount(gmem0_DDR_global_avm_burstcount[2]),
      .mmul_0_avm_memdep_mmul_writeack(gmem0_DDR_global_avm_writeack[2])
   );
...
(
   ...
   // AVM mmul_0_avm_memdep_mmul
   output logic mmul_0_avm_memdep_mmul_enable,
   output logic mmul_0_avm_memdep_mmul_read,
   output logic mmul_0_avm_memdep_mmul_write,
   output logic [30:0] mmul_0_avm_memdep_mmul_address,
   output logic [511:0] mmul_0_avm_memdep_mmul_writedata,
   output logic [63:0] mmul_0_avm_memdep_mmul_byteenable,
   input logic mmul_0_avm_memdep_mmul_waitrequest,
   input logic [511:0] mmul_0_avm_memdep_mmul_readdata,
   input logic mmul_0_avm_memdep_mmul_readdatavalid,
   output logic [4:0] mmul_0_avm_memdep_mmul_burstcount,
   input logic mmul_0_avm_memdep_mmul_writeack
);
   logic mmul_start;
   ...
   (
      ...
      // AVM avm_memdep_mmul
      .avm_memdep_mmul_enable(mmul_0_avm_memdep_mmul_enable),
      .avm_memdep_mmul_read(mmul_0_avm_memdep_mmul_read),
      .avm_memdep_mmul_write(mmul_0_avm_memdep_mmul_write),
      .avm_memdep_mmul_address(mmul_0_avm_memdep_mmul_address),
      .avm_memdep_mmul_writedata(mmul_0_avm_memdep_mmul_writedata),
      .avm_memdep_mmul_byteenable(mmul_0_avm_memdep_mmul_byteenable),
      .avm_memdep_mmul_waitrequest(mmul_0_avm_memdep_mmul_waitrequest),
      .avm_memdep_mmul_readdata(mmul_0_avm_memdep_mmul_readdata),
      .avm_memdep_mmul_readdatavalid(mmul_0_avm_memdep_mmul_readdatavalid),
      .avm_memdep_mmul_burstcount(mmul_0_avm_memdep_mmul_burstcount),
      .avm_memdep_mmul_writeack(mmul_0_avm_memdep_mmul_writeack)
   );
...
(
   ...
   // AVM avm_memdep_mmul
   output logic avm_memdep_mmul_enable,
   output logic avm_memdep_mmul_read,
   output logic avm_memdep_mmul_write,
   output logic [30:0] avm_memdep_mmul_address,
   output logic [511:0] avm_memdep_mmul_writedata,
   output logic [63:0] avm_memdep_mmul_byteenable,
   input logic avm_memdep_mmul_waitrequest,
   input logic [511:0] avm_memdep_mmul_readdata,
   input logic avm_memdep_mmul_readdatavalid,
   output logic [4:0] avm_memdep_mmul_burstcount,
   input logic avm_memdep_mmul_writeack
);
   ...
   (
      ...
      // AVM avm_memdep_mmul
      .avm_memdep_mmul_enable(avm_memdep_mmul_enable),
      .avm_memdep_mmul_read(avm_memdep_mmul_read),
      .avm_memdep_mmul_write(avm_memdep_mmul_write),
      .avm_memdep_mmul_address(avm_memdep_mmul_address),
      .avm_memdep_mmul_writedata(avm_memdep_mmul_writedata),
      .avm_memdep_mmul_byteenable(avm_memdep_mmul_byteenable),
      .avm_memdep_mmul_waitrequest(avm_memdep_mmul_waitrequest),
      .avm_memdep_mmul_readdata(avm_memdep_mmul_readdata),
      .avm_memdep_mmul_readdatavalid(avm_memdep_mmul_readdatavalid),
      .avm_memdep_mmul_burstcount(avm_memdep_mmul_burstcount),
      .avm_memdep_mmul_writeack(avm_memdep_mmul_writeack)
   );
