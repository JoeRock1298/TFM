...
module mmul_B6_merge_reg (
    ...
    reg [0:0] mmul_B6_merge_reg_data_reg_4_x_q;
    reg [0:0] mmul_B6_merge_reg_data_reg_5_x_q;
    reg [0:0] mmul_B6_merge_reg_data_reg_6_x_q;
    reg [31:0] mmul_B6_merge_reg_data_reg_7_x_q;
    reg [0:0] mmul_B6_merge_reg_data_reg_8_x_q;
    reg [31:0] mmul_B6_merge_reg_data_reg_9_x_q;
    reg [0:0] mmul_B6_merge_reg_data_reg_10_x_q;
    reg [0:0] mmul_B6_merge_reg_data_reg_11_x_q;
    reg [0:0] mmul_B6_merge_reg_data_reg_12_x_q;
    ...
    // mmul_B6_merge_reg_data_reg_12_x(REG,21)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            mmul_B6_merge_reg_data_reg_12_x_q <= $unsigned(1'b0);
        end
        else if (stall_in_not_or_mmul_B6_merge_reg_valid_reg_q == 1'b1)
        begin
            mmul_B6_merge_reg_data_reg_12_x_q <= in_data_in_12_tpl;
        end
    end

    // mmul_B6_merge_reg_data_reg_11_x(REG,20)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            mmul_B6_merge_reg_data_reg_11_x_q <= $unsigned(1'b0);
        end
        else if (stall_in_not_or_mmul_B6_merge_reg_valid_reg_q == 1'b1)
        begin
            mmul_B6_merge_reg_data_reg_11_x_q <= in_data_in_11_tpl;
        end
    end

    // mmul_B6_merge_reg_data_reg_10_x(REG,19)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            mmul_B6_merge_reg_data_reg_10_x_q <= $unsigned(1'b0);
        end
        else if (stall_in_not_or_mmul_B6_merge_reg_valid_reg_q == 1'b1)
        begin
            mmul_B6_merge_reg_data_reg_10_x_q <= in_data_in_10_tpl;
        end
    end

    // mmul_B6_merge_reg_data_reg_9_x(REG,18)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            mmul_B6_merge_reg_data_reg_9_x_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (stall_in_not_or_mmul_B6_merge_reg_valid_reg_q == 1'b1)
        begin
            mmul_B6_merge_reg_data_reg_9_x_q <= in_data_in_9_tpl;
        end
    end

    // mmul_B6_merge_reg_data_reg_8_x(REG,17)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            mmul_B6_merge_reg_data_reg_8_x_q <= $unsigned(1'b0);
        end
        else if (stall_in_not_or_mmul_B6_merge_reg_valid_reg_q == 1'b1)
        begin
            mmul_B6_merge_reg_data_reg_8_x_q <= in_data_in_8_tpl;
        end
    end

    // mmul_B6_merge_reg_data_reg_7_x(REG,16)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            mmul_B6_merge_reg_data_reg_7_x_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (stall_in_not_or_mmul_B6_merge_reg_valid_reg_q == 1'b1)
        begin
            mmul_B6_merge_reg_data_reg_7_x_q <= in_data_in_7_tpl;
        end
    end
    ...
    begin
        if (!resetn)
        begin
            mmul_B6_merge_reg_data_reg_5_x_q <= $unsigned(1'b0);
        end
        else if (stall_in_not_or_mmul_B6_merge_reg_valid_reg_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            mmul_B6_merge_reg_data_reg_4_x_q <= $unsigned(1'b0);
        end
        else if (stall_in_not_or_mmul_B6_merge_reg_valid_reg_q == 1'b1)
        begin
    ...
    assign out_data_out_7_tpl = mmul_B6_merge_reg_data_reg_7_x_q;
    assign out_data_out_8_tpl = mmul_B6_merge_reg_data_reg_8_x_q;
    assign out_data_out_9_tpl = mmul_B6_merge_reg_data_reg_9_x_q;
    assign out_data_out_10_tpl = mmul_B6_merge_reg_data_reg_10_x_q;
    assign out_data_out_11_tpl = mmul_B6_merge_reg_data_reg_11_x_q;
    assign out_data_out_12_tpl = mmul_B6_merge_reg_data_reg_12_x_q;
