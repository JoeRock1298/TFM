...
// SystemVerilog created from mmul_i_sfc_logic_s_c0_in_for_cond5_prehe0000h_s_c0_enter12_mmul0
...
module mmul_i_sfc_logic_s_c0_in_for_cond5_prehe0000h_s_c0_enter12_mmul0 (
    ...
    wire [0:0] i_fpga_indvars_iv22_replace_phi_mmul5_s;
    reg [32:0] i_fpga_indvars_iv22_replace_phi_mmul5_q;
    wire [33:0] i_fpga_indvars_iv_next23_mmul15_a;
    wire [33:0] i_fpga_indvars_iv_next23_mmul15_b;
    logic [33:0] i_fpga_indvars_iv_next23_mmul15_o;
    wire [33:0] i_fpga_indvars_iv_next23_mmul15_q;
    ...
    wire [32:0] i_llvm_fpga_pop_i33_fpga_indvars_iv22_pop7_mmul4_out_data_out;
    wire [0:0] i_llvm_fpga_pop_i33_fpga_indvars_iv22_pop7_mmul4_out_feedback_stall_out_7;
    ...
    wire [63:0] i_llvm_fpga_push_i33_fpga_indvars_iv22_push7_mmul16_out_feedback_out_7;
    wire [0:0] i_llvm_fpga_push_i33_fpga_indvars_iv22_push7_mmul16_out_feedback_valid_out_7;
    ...
    wire [32:0] bgTrunc_i_fpga_indvars_iv_next23_mmul15_sel_x_b;
    ...
    wire [0:0] i_exitcond24_mmul9_cmp_nsign_q;
    ...
    reg [0:0] redist1_sync_together47_aunroll_x_in_c0_eni1_1_tpl_4_q;
    reg [0:0] redist1_sync_together47_aunroll_x_in_c0_eni1_1_tpl_4_delay_0;
    reg [0:0] redist1_sync_together47_aunroll_x_in_c0_eni1_1_tpl_4_delay_1;
    reg [0:0] redist2_sync_together47_aunroll_x_in_i_valid_3_q;
    reg [0:0] redist2_sync_together47_aunroll_x_in_i_valid_3_delay_0;
    reg [0:0] redist2_sync_together47_aunroll_x_in_i_valid_3_delay_1;
    reg [0:0] redist3_i_unnamed_mmul12_q_1_q;
    reg [0:0] redist4_i_unnamed_mmul12_q_4_q;
    reg [0:0] redist4_i_unnamed_mmul12_q_4_delay_0;
    reg [0:0] redist4_i_unnamed_mmul12_q_4_delay_1;
    ...
    // i_fpga_indvars_iv_next23_mmul15(ADD,24)@1
    assign i_fpga_indvars_iv_next23_mmul15_a = {1'b0, i_fpga_indvars_iv22_replace_phi_mmul5_q};
    assign i_fpga_indvars_iv_next23_mmul15_b = {1'b0, c_i33_133_q};
    assign i_fpga_indvars_iv_next23_mmul15_o = $unsigned(i_fpga_indvars_iv_next23_mmul15_a) + $unsigned(i_fpga_indvars_iv_next23_mmul15_b);
    assign i_fpga_indvars_iv_next23_mmul15_q = i_fpga_indvars_iv_next23_mmul15_o[33:0];

    // bgTrunc_i_fpga_indvars_iv_next23_mmul15_sel_x(BITSELECT,45)@1
    assign bgTrunc_i_fpga_indvars_iv_next23_mmul15_sel_x_b = i_fpga_indvars_iv_next23_mmul15_q[32:0];

    // i_llvm_fpga_push_i33_fpga_indvars_iv22_push7_mmul16(BLACKBOX,33)@1
    // out out_feedback_out_7@20000000
    // out out_feedback_valid_out_7@20000000
    mmul_i_llvm_fpga_push_i33_fpga_indvars_iv22_push7_0 thei_llvm_fpga_push_i33_fpga_indvars_iv22_push7_mmul16 (
        .in_data_in(bgTrunc_i_fpga_indvars_iv_next23_mmul15_sel_x_b),
        .in_feedback_stall_in_7(i_llvm_fpga_pop_i33_fpga_indvars_iv22_pop7_mmul4_out_feedback_stall_out_7),
        .in_stall_in(GND_q),
        .in_unnamed_mmul9(i_unnamed_mmul12_q),
        .in_valid_in(in_i_valid),
        .out_data_out(),
        .out_feedback_out_7(i_llvm_fpga_push_i33_fpga_indvars_iv22_push7_mmul16_out_feedback_out_7),
        .out_feedback_valid_out_7(i_llvm_fpga_push_i33_fpga_indvars_iv22_push7_mmul16_out_feedback_valid_out_7),
        .out_stall_out(),
        .out_valid_out(),
        .clock(clock),
        .resetn(resetn)
    ...
    // i_llvm_fpga_pop_i33_fpga_indvars_iv22_pop7_mmul4(BLACKBOX,30)@1
    // out out_feedback_stall_out_7@20000000
    mmul_i_llvm_fpga_pop_i33_fpga_indvars_iv22_pop7_0 thei_llvm_fpga_pop_i33_fpga_indvars_iv22_pop7_mmul4 (
        .in_data_in(c_i33_undef30_q),
        .in_dir(in_c0_eni1_1_tpl),
        .in_feedback_in_7(i_llvm_fpga_push_i33_fpga_indvars_iv22_push7_mmul16_out_feedback_out_7),
        .in_feedback_valid_in_7(i_llvm_fpga_push_i33_fpga_indvars_iv22_push7_mmul16_out_feedback_valid_out_7),
        .in_predicate(GND_q),
        .in_stall_in(GND_q),
        .in_valid_in(in_i_valid),
        .out_data_out(i_llvm_fpga_pop_i33_fpga_indvars_iv22_pop7_mmul4_out_data_out),
        .out_feedback_stall_out_7(i_llvm_fpga_pop_i33_fpga_indvars_iv22_pop7_mmul4_out_feedback_stall_out_7),
        .out_stall_out(),
        .out_valid_out(),
        .clock(clock),
        .resetn(resetn)
    ...
    // i_fpga_indvars_iv22_replace_phi_mmul5(MUX,23)@1
    assign i_fpga_indvars_iv22_replace_phi_mmul5_s = in_c0_eni1_1_tpl;
    always @(i_fpga_indvars_iv22_replace_phi_mmul5_s or i_llvm_fpga_pop_i33_fpga_indvars_iv22_pop7_mmul4_out_data_out or i_llvm_fpga_ffwd_dest_i33_unnamed_mmul2_mmul3_out_dest_data_out_1_0)
    begin
        unique case (i_fpga_indvars_iv22_replace_phi_mmul5_s)
            1'b0 : i_fpga_indvars_iv22_replace_phi_mmul5_q = i_llvm_fpga_pop_i33_fpga_indvars_iv22_pop7_mmul4_out_data_out;
            1'b1 : i_fpga_indvars_iv22_replace_phi_mmul5_q = i_llvm_fpga_ffwd_dest_i33_unnamed_mmul2_mmul3_out_dest_data_out_1_0;
            default : i_fpga_indvars_iv22_replace_phi_mmul5_q = 33'b0;
        endcase
    end

    // i_exitcond24_mmul9_cmp_nsign(LOGICAL,59)@1
    assign i_exitcond24_mmul9_cmp_nsign_q = $unsigned(~ (i_fpga_indvars_iv22_replace_phi_mmul5_q[32:32]));
    ...
    assign i_unnamed_mmul12_q = i_llvm_fpga_ffwd_dest_i1_cmp276_mmul11_out_dest_data_out_0_0 & i_exitcond24_mmul9_cmp_nsign_q;
    ...
    // redist2_sync_together47_aunroll_x_in_i_valid_3(DELAY,82)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist2_sync_together47_aunroll_x_in_i_valid_3_delay_0 <= '0;
            redist2_sync_together47_aunroll_x_in_i_valid_3_delay_1 <= '0;
            redist2_sync_together47_aunroll_x_in_i_valid_3_q <= '0;
        end
        else
        begin
            redist2_sync_together47_aunroll_x_in_i_valid_3_delay_0 <= $unsigned(in_i_valid);
            redist2_sync_together47_aunroll_x_in_i_valid_3_delay_1 <= redist2_sync_together47_aunroll_x_in_i_valid_3_delay_0;
            redist2_sync_together47_aunroll_x_in_i_valid_3_q <= redist2_sync_together47_aunroll_x_in_i_valid_3_delay_1;
        end
    end
    ...
    begin
        ...
        begin
            valid_fanout_reg0_q <= $unsigned(redist2_sync_together47_aunroll_x_in_i_valid_3_q);
        end
    end
    ...
    // redist1_sync_together47_aunroll_x_in_c0_eni1_1_tpl_4(DELAY,81)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist1_sync_together47_aunroll_x_in_c0_eni1_1_tpl_4_delay_0 <= '0;
            redist1_sync_together47_aunroll_x_in_c0_eni1_1_tpl_4_delay_1 <= '0;
            redist1_sync_together47_aunroll_x_in_c0_eni1_1_tpl_4_q <= '0;
        end
        else
        begin
            redist1_sync_together47_aunroll_x_in_c0_eni1_1_tpl_4_delay_0 <= $unsigned(redist0_sync_together47_aunroll_x_in_c0_eni1_1_tpl_1_q);
            redist1_sync_together47_aunroll_x_in_c0_eni1_1_tpl_4_delay_1 <= redist1_sync_together47_aunroll_x_in_c0_eni1_1_tpl_4_delay_0;
            redist1_sync_together47_aunroll_x_in_c0_eni1_1_tpl_4_q <= redist1_sync_together47_aunroll_x_in_c0_eni1_1_tpl_4_delay_1;
        end
    end

    // i_notcmp16_mmul13(LOGICAL,36)@5
    assign i_notcmp16_mmul13_q = redist4_i_unnamed_mmul12_q_4_q ^ VCC_q;

    // redist3_i_unnamed_mmul12_q_1(DELAY,83)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist3_i_unnamed_mmul12_q_1_q <= '0;
        end
        else
        begin
            redist3_i_unnamed_mmul12_q_1_q <= $unsigned(i_unnamed_mmul12_q);
        end
    end

    // redist4_i_unnamed_mmul12_q_4(DELAY,84)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist4_i_unnamed_mmul12_q_4_delay_0 <= '0;
            redist4_i_unnamed_mmul12_q_4_delay_1 <= '0;
            redist4_i_unnamed_mmul12_q_4_q <= '0;
        end
        else
        begin
            redist4_i_unnamed_mmul12_q_4_delay_0 <= $unsigned(redist3_i_unnamed_mmul12_q_1_q);
            redist4_i_unnamed_mmul12_q_4_delay_1 <= redist4_i_unnamed_mmul12_q_4_delay_0;
            redist4_i_unnamed_mmul12_q_4_q <= redist4_i_unnamed_mmul12_q_4_delay_1;
        end
    end
    ...
    mmul_i_llvm_fpga_push_i32_i_028_push8_0 thei_llvm_fpga_push_i32_i_028_push8_mmul18 (
        ...
        .in_stall_in(GND_q),
        .in_unnamed_mmul9(redist3_i_unnamed_mmul12_q_1_q),
    ...
    assign out_c0_exi4_1_tpl = bgTrunc_i_mul_mmul8_sel_x_b;
    assign out_c0_exi4_2_tpl = redist4_i_unnamed_mmul12_q_4_q;
    assign out_c0_exi4_3_tpl = i_notcmp16_mmul13_q;
    assign out_c0_exi4_4_tpl = redist1_sync_together47_aunroll_x_in_c0_eni1_1_tpl_4_q;
