...
module mmul_bb_B1 (
    ...
    wire [0:0] bb_mmul_B1_stall_region_out_c0_exe2;
    wire [0:0] bb_mmul_B1_stall_region_out_c0_exe3;
    wire [0:0] bb_mmul_B1_stall_region_out_feedback_stall_out_9;
    wire [0:0] bb_mmul_B1_stall_region_out_memdep_phi17_pop9;
    ...
    wire [0:0] mmul_B1_branch_out_c0_exe2;
    wire [0:0] mmul_B1_branch_out_c0_exe3;
    wire [0:0] mmul_B1_branch_out_memdep_phi17_pop9;
    ...
    mmul_bb_B1_stall_region thebb_mmul_B1_stall_region (
        ...
        .out_c0_exe2(bb_mmul_B1_stall_region_out_c0_exe2),
        .out_c0_exe3(bb_mmul_B1_stall_region_out_c0_exe3),
        .out_feedback_stall_out_9(bb_mmul_B1_stall_region_out_feedback_stall_out_9),
        .out_memdep_phi17_pop9(bb_mmul_B1_stall_region_out_memdep_phi17_pop9),
    ...
    // feedback_stall_out_9_sync(GPOUT,4)
    assign out_feedback_stall_out_9 = bb_mmul_B1_stall_region_out_feedback_stall_out_9;

    // out_c0_exe1(GPOUT,19)
    assign out_c0_exe1 = mmul_B1_branch_out_c0_exe1;

    // out_c0_exe2(GPOUT,20)
    assign out_c0_exe2 = mmul_B1_branch_out_c0_exe2;
    ...
    // out_memdep_phi17_pop9(GPOUT,24)
    assign out_memdep_phi17_pop9 = mmul_B1_branch_out_memdep_phi17_pop9;
