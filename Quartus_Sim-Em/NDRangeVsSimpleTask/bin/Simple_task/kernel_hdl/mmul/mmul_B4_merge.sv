...
module mmul_B4_merge (
    ...
    output wire [0:0] out_c0_exe111015,
    ...
    // out_c0_exe111015(GPOUT,7)
    assign out_c0_exe111015 = in_c0_exe111015_0;

    // out_c0_exe121027(GPOUT,8)
    assign out_c0_exe121027 = in_c0_exe121027_0;
