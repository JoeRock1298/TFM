...
add_instance Simple_task_sys Simple_task_sys

add_connection clk_1x.out_clk Simple_task_sys.clock_reset
add_connection clk_2x.out_clk Simple_task_sys.clock_reset2x
add_connection reset.out_reset Simple_task_sys.clock_reset_reset

add_interface kernel_mem0 avalon slave
set_interface_property kernel_mem0 EXPORT_OF Simple_task_sys.avm_mem_gmem0_DDR_port_0_0_rw
...
add_connection kernel_irq.receiver_irq Simple_task_sys.kernel_irq
...
add_connection kernel_cra.m0 Simple_task_sys.cra_ring_root_avs
set_connection_parameter_value kernel_cra.m0/Simple_task_sys.cra_ring_root_avs baseAddress "0x0"
