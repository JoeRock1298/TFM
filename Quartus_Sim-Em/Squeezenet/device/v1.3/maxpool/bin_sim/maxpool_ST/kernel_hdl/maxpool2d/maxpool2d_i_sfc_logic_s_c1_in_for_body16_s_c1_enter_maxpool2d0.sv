...
module maxpool2d_i_sfc_logic_s_c1_in_for_body16_s_c1_enter_maxpool2d0 (
    ...
    // valid_fanout_reg0(REG,76)@150 + 1
    ...
    // valid_fanout_reg1(REG,77)@150 + 1
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // valid_fanout_reg2(REG,78)@150 + 1
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // i_llvm_fpga_push_f32_tmp_129_push39_maxpool2d5(BLACKBOX,7)@151
    ...
    // i_llvm_fpga_pop_coalesce_f32_tmp_129_pop39_maxpool2d2(BLACKBOX,6)@151
    ...
    // frac_y_uid34_i_cmp21_maxpool2d3(BITSELECT,33)@151
    ...
    // fracXIsZero_uid37_i_cmp21_maxpool2d3(LOGICAL,36)@151
    ...
    // signX_uid61_i_cmp21_maxpool2d3(BITSELECT,60)@151
    ...
    // efxLTefy_uid57_i_cmp21_maxpool2d3(COMPARE,56)@151
    ...
    // expFracCompMux_uid68_i_cmp21_maxpool2d3(MUX,67)@151
    ...
    // expXIsMax_uid36_i_cmp21_maxpool2d3(LOGICAL,35)@151
    ...
    // i_unnamed_maxpool2d4(MUX,8)@151
    ...
    // sync_out_aunroll_x(GPOUT,10)@151
