...
module maxpool2d_function_wrapper (
    ...
    input wire [511:0] avm_unnamed_maxpool2d1_maxpool2d_readdata,
    input wire [0:0] avm_unnamed_maxpool2d1_maxpool2d_readdatavalid,
    input wire [0:0] avm_unnamed_maxpool2d1_maxpool2d_waitrequest,
    input wire [0:0] avm_unnamed_maxpool2d1_maxpool2d_writeack,
    ...
    output wire [30:0] avm_unnamed_maxpool2d1_maxpool2d_address,
    output wire [4:0] avm_unnamed_maxpool2d1_maxpool2d_burstcount,
    output wire [63:0] avm_unnamed_maxpool2d1_maxpool2d_byteenable,
    output wire [0:0] avm_unnamed_maxpool2d1_maxpool2d_enable,
    output wire [0:0] avm_unnamed_maxpool2d1_maxpool2d_read,
    output wire [0:0] avm_unnamed_maxpool2d1_maxpool2d_write,
    output wire [511:0] avm_unnamed_maxpool2d1_maxpool2d_writedata,
    ...
    wire [0:0] maxpool2d_function_out_o_active_unnamed_maxpool2d1;
    wire [0:0] maxpool2d_function_out_stall_out;
    wire [30:0] maxpool2d_function_out_unnamed_maxpool2d1_maxpool2d_avm_address;
    wire [4:0] maxpool2d_function_out_unnamed_maxpool2d1_maxpool2d_avm_burstcount;
    wire [63:0] maxpool2d_function_out_unnamed_maxpool2d1_maxpool2d_avm_byteenable;
    wire [0:0] maxpool2d_function_out_unnamed_maxpool2d1_maxpool2d_avm_enable;
    wire [0:0] maxpool2d_function_out_unnamed_maxpool2d1_maxpool2d_avm_read;
    wire [0:0] maxpool2d_function_out_unnamed_maxpool2d1_maxpool2d_avm_write;
    wire [511:0] maxpool2d_function_out_unnamed_maxpool2d1_maxpool2d_avm_writedata;
    ...
    // arg_output_size_select(BITSELECT,6)
    assign arg_output_size_select_b = kernel_arguments[63:32];

    // arg_output_im_select(BITSELECT,5)
    assign arg_output_im_select_b = kernel_arguments[191:128];

    // arg_input_size_select(BITSELECT,4)
    ...
    // maxpool2d_function(BLACKBOX,51)
    maxpool2d_function themaxpool2d_function (
        ...
        .in_stall_in(GND_q),
        .in_start(start),
        .in_unnamed_maxpool2d1_maxpool2d_avm_readdata(avm_unnamed_maxpool2d1_maxpool2d_readdata),
        .in_unnamed_maxpool2d1_maxpool2d_avm_readdatavalid(avm_unnamed_maxpool2d1_maxpool2d_readdatavalid),
        .in_unnamed_maxpool2d1_maxpool2d_avm_waitrequest(avm_unnamed_maxpool2d1_maxpool2d_waitrequest),
        .in_unnamed_maxpool2d1_maxpool2d_avm_writeack(avm_unnamed_maxpool2d1_maxpool2d_writeack),
        ...
        .out_unnamed_maxpool2d1_maxpool2d_avm_address(maxpool2d_function_out_unnamed_maxpool2d1_maxpool2d_avm_address),
        .out_unnamed_maxpool2d1_maxpool2d_avm_burstcount(maxpool2d_function_out_unnamed_maxpool2d1_maxpool2d_avm_burstcount),
        .out_unnamed_maxpool2d1_maxpool2d_avm_byteenable(maxpool2d_function_out_unnamed_maxpool2d1_maxpool2d_avm_byteenable),
        .out_unnamed_maxpool2d1_maxpool2d_avm_enable(maxpool2d_function_out_unnamed_maxpool2d1_maxpool2d_avm_enable),
        .out_unnamed_maxpool2d1_maxpool2d_avm_read(maxpool2d_function_out_unnamed_maxpool2d1_maxpool2d_avm_read),
        .out_unnamed_maxpool2d1_maxpool2d_avm_write(maxpool2d_function_out_unnamed_maxpool2d1_maxpool2d_avm_write),
        .out_unnamed_maxpool2d1_maxpool2d_avm_writedata(maxpool2d_function_out_unnamed_maxpool2d1_maxpool2d_avm_writedata),
        .out_valid_out(maxpool2d_function_out_valid_out),
        .clock(clock),
        .resetn(resetn)
    );

    // avm_lm_maxpool2d_address(GPOUT,52)
    assign avm_lm_maxpool2d_address = maxpool2d_function_out_lm_maxpool2d_avm_address;

    // avm_lm_maxpool2d_burstcount(GPOUT,53)
    assign avm_lm_maxpool2d_burstcount = maxpool2d_function_out_lm_maxpool2d_avm_burstcount;

    // avm_lm_maxpool2d_byteenable(GPOUT,54)
    assign avm_lm_maxpool2d_byteenable = maxpool2d_function_out_lm_maxpool2d_avm_byteenable;

    // avm_lm_maxpool2d_enable(GPOUT,55)
    assign avm_lm_maxpool2d_enable = maxpool2d_function_out_lm_maxpool2d_avm_enable;

    // avm_lm_maxpool2d_read(GPOUT,56)
    assign avm_lm_maxpool2d_read = maxpool2d_function_out_lm_maxpool2d_avm_read;

    // avm_lm_maxpool2d_write(GPOUT,57)
    assign avm_lm_maxpool2d_write = maxpool2d_function_out_lm_maxpool2d_avm_write;

    // avm_lm_maxpool2d_writedata(GPOUT,58)
    assign avm_lm_maxpool2d_writedata = maxpool2d_function_out_lm_maxpool2d_avm_writedata;

    // avm_unnamed_maxpool2d1_maxpool2d_address(GPOUT,59)
    assign avm_unnamed_maxpool2d1_maxpool2d_address = maxpool2d_function_out_unnamed_maxpool2d1_maxpool2d_avm_address;

    // avm_unnamed_maxpool2d1_maxpool2d_burstcount(GPOUT,60)
    assign avm_unnamed_maxpool2d1_maxpool2d_burstcount = maxpool2d_function_out_unnamed_maxpool2d1_maxpool2d_avm_burstcount;

    // avm_unnamed_maxpool2d1_maxpool2d_byteenable(GPOUT,61)
    assign avm_unnamed_maxpool2d1_maxpool2d_byteenable = maxpool2d_function_out_unnamed_maxpool2d1_maxpool2d_avm_byteenable;

    // avm_unnamed_maxpool2d1_maxpool2d_enable(GPOUT,62)
    assign avm_unnamed_maxpool2d1_maxpool2d_enable = maxpool2d_function_out_unnamed_maxpool2d1_maxpool2d_avm_enable;

    // avm_unnamed_maxpool2d1_maxpool2d_read(GPOUT,63)
    assign avm_unnamed_maxpool2d1_maxpool2d_read = maxpool2d_function_out_unnamed_maxpool2d1_maxpool2d_avm_read;

    // avm_unnamed_maxpool2d1_maxpool2d_write(GPOUT,64)
    assign avm_unnamed_maxpool2d1_maxpool2d_write = maxpool2d_function_out_unnamed_maxpool2d1_maxpool2d_avm_write;

    // avm_unnamed_maxpool2d1_maxpool2d_writedata(GPOUT,65)
    assign avm_unnamed_maxpool2d1_maxpool2d_writedata = maxpool2d_function_out_unnamed_maxpool2d1_maxpool2d_avm_writedata;
    ...
    assign has_a_lsu_active = maxpool2d_function_out_o_active_unnamed_maxpool2d1;

    // has_a_write_pending(GPOUT,68)
    assign has_a_write_pending = maxpool2d_function_out_o_active_unnamed_maxpool2d1;
