...
module maxpool2d_i_sfc_logic_s_c1_in_for_cond170000_c1_enter_maxpool2d0 (
    ...
    // frac_y_uid30_i_cmp27_maxpool2d2(BITSELECT,29)@154
    ...
    // fracXIsZero_uid33_i_cmp27_maxpool2d2(LOGICAL,32)@154
    ...
    // exp_y_uid29_i_cmp27_maxpool2d2(BITSELECT,28)@154
    assign exp_y_uid29_i_cmp27_maxpool2d2_b = in_c1_eni2_1_tpl[30:23];

    // expXIsZero_uid31_i_cmp27_maxpool2d2(LOGICAL,30)@154
    ...
    // exp_x_uid12_i_cmp27_maxpool2d2(BITSELECT,11)@154
    assign exp_x_uid12_i_cmp27_maxpool2d2_b = in_c1_eni2_2_tpl[30:23];

    // expXIsZero_uid14_i_cmp27_maxpool2d2(LOGICAL,13)@154
    ...
    // efxLTefy_uid53_i_cmp27_maxpool2d2(COMPARE,52)@154
    ...
    // expFracCompMux_uid64_i_cmp27_maxpool2d2(MUX,63)@154
    ...
    // r_uid70_i_cmp27_maxpool2d2(LOGICAL,69)@154 + 1
    ...
    // fracXIsNotZero_uid34_i_cmp27_maxpool2d2(LOGICAL,33)@154
    ...
    // expXIsMax_uid32_i_cmp27_maxpool2d2(LOGICAL,31)@154
    ...
    // rPostExc_uid71_i_cmp27_maxpool2d2(MUX,70)@155
    ...
    // i_unnamed_maxpool2d3(MUX,4)@155
    ...
    // sync_out_aunroll_x(GPOUT,6)@155
