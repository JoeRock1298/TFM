...
module conv2d1x1_B4_branch (
    ...
    input wire [31:0] in_c0_exe10273,
    input wire [0:0] in_c0_exe11274,
    input wire [31:0] in_c0_exe12,
    input wire [0:0] in_c0_exe1264,
    ...
    input wire [0:0] in_c0_exe3266,
    input wire [31:0] in_c0_exe4267,
    input wire [31:0] in_c0_exe5268,
    input wire [0:0] in_c0_exe6269,
    input wire [0:0] in_c0_exe7270,
    input wire [31:0] in_c0_exe8271,
    input wire [31:0] in_c0_exe9272,
    ...
    // out_c0_exe10273(GPOUT,25)
    assign out_c0_exe10273 = in_c0_exe10273;

    // out_c0_exe11274(GPOUT,26)
    assign out_c0_exe11274 = in_c0_exe11274;

    // out_c0_exe12(GPOUT,27)
    assign out_c0_exe12 = in_c0_exe12;

    // out_c0_exe1264(GPOUT,28)
    assign out_c0_exe1264 = in_c0_exe1264;
    ...
    // out_c0_exe3266(GPOUT,37)
    assign out_c0_exe3266 = in_c0_exe3266;

    // out_c0_exe4267(GPOUT,38)
    assign out_c0_exe4267 = in_c0_exe4267;

    // out_c0_exe5268(GPOUT,39)
    assign out_c0_exe5268 = in_c0_exe5268;

    // out_c0_exe6269(GPOUT,40)
    assign out_c0_exe6269 = in_c0_exe6269;

    // out_c0_exe7270(GPOUT,41)
    assign out_c0_exe7270 = in_c0_exe7270;

    // out_c0_exe8271(GPOUT,42)
    assign out_c0_exe8271 = in_c0_exe8271;

    // out_c0_exe9272(GPOUT,43)
    assign out_c0_exe9272 = in_c0_exe9272;
