...
module conv2d1x1_i_llvm_fpga_sfc_exit_s_c0_out_0000conv2d1x11_data_fifo (
    ...
    wire [32:0] adapt_scalar_trunc36_in;
    wire [32:0] adapt_scalar_trunc36_q;
    ...
    wire [383:0] i_llvm_fpga_sfc_exit_s_c0_out_for_body_conv2d1x1s_c0_exit_conv2d1x10_i_data;
    ...
    wire [383:0] i_llvm_fpga_sfc_exit_s_c0_out_for_body_conv2d1x1s_c0_exit_conv2d1x10_o_data;
    ...
    wire [32:0] ip_dsdk_adapt_bitselect35_b;
    ...
    assign dsdk_ip_adapt_bitjoin1_q = {c_i48_021_q, element_extension19_q, element_extension17_q, in_i_data_9_tpl, in_i_data_8_tpl, in_i_data_7_tpl, element_extension15_q, c_i40_014_q, element_extension12_q, element_extension10_q, element_extension8_q, in_i_data_2_tpl, c_i16_07_q, element_extension5_q, element_extension3_q};

    // i_llvm_fpga_sfc_exit_s_c0_out_for_body_conv2d1x1s_c0_exit_conv2d1x10(EXTIFACE,30)
    ...
    assign ip_dsdk_adapt_bitselect45_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body_conv2d1x1s_c0_exit_conv2d1x10_o_data[328:328];
    ...
    assign ip_dsdk_adapt_bitselect43_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body_conv2d1x1s_c0_exit_conv2d1x10_o_data[320:320];
    ...
    assign ip_dsdk_adapt_bitselect41_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body_conv2d1x1s_c0_exit_conv2d1x10_o_data[319:288];

    // ip_dsdk_adapt_bitselect39(BITSELECT,39)
    assign ip_dsdk_adapt_bitselect39_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body_conv2d1x1s_c0_exit_conv2d1x10_o_data[287:256];

    // ip_dsdk_adapt_bitselect37(BITSELECT,38)
    assign ip_dsdk_adapt_bitselect37_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body_conv2d1x1s_c0_exit_conv2d1x10_o_data[255:192];

    // ip_dsdk_adapt_bitselect35(BITSELECT,37)
    assign ip_dsdk_adapt_bitselect35_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body_conv2d1x1s_c0_exit_conv2d1x10_o_data[160:128];

    // adapt_scalar_trunc36(ROUND,7)
    assign adapt_scalar_trunc36_in = ip_dsdk_adapt_bitselect35_b;
    assign adapt_scalar_trunc36_q = adapt_scalar_trunc36_in[32:0];

    // ip_dsdk_adapt_bitselect33(BITSELECT,36)
    assign ip_dsdk_adapt_bitselect33_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body_conv2d1x1s_c0_exit_conv2d1x10_o_data[80:80];
    ...
    assign ip_dsdk_adapt_bitselect31_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body_conv2d1x1s_c0_exit_conv2d1x10_o_data[72:72];
    ...
    assign ip_dsdk_adapt_bitselect29_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body_conv2d1x1s_c0_exit_conv2d1x10_o_data[64:64];
    ...
    assign ip_dsdk_adapt_bitselect27_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body_conv2d1x1s_c0_exit_conv2d1x10_o_data[63:32];

    // ip_dsdk_adapt_bitselect25(BITSELECT,32)
    assign ip_dsdk_adapt_bitselect25_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body_conv2d1x1s_c0_exit_conv2d1x10_o_data[8:8];
    ...
    assign ip_dsdk_adapt_bitselect23_b = i_llvm_fpga_sfc_exit_s_c0_out_for_body_conv2d1x1s_c0_exit_conv2d1x10_o_data[0:0];
    ...
    // dupName_0_sync_out_aunroll_x(GPOUT,50)@20000003
    ...
    assign out_o_data_4_tpl = adapt_scalar_trunc32_q;
