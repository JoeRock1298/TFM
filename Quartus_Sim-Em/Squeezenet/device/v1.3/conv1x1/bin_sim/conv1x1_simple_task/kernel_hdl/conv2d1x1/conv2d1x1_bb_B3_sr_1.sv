...
module conv2d1x1_bb_B3_sr_1 (
    ...
    // out_o_stall(GPOUT,27)
    assign out_o_stall = sr_valid_q;

    // out_o_valid(GPOUT,28)
    ...
    begin
        if (!resetn)
        begin
            sr_6_x_q <= $unsigned(33'b000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
    ...
    begin
        unique case (data_mux_6_x_s)
            ...
            default : data_mux_6_x_q = 33'b0;
        endcase
    end

    // out_o_data_6_tpl(GPOUT,35)
