...
// SystemVerilog created from conv2d1x1_bb_B3_sr_1
...
module conv2d1x1_bb_B3_sr_1 (
    ...
    // out_o_stall(GPOUT,41)
    assign out_o_stall = sr_valid_q;

    // out_o_valid(GPOUT,42)
