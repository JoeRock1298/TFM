...
// SystemVerilog created from conv2d1x1_i_sfc_logic_s_c0_in_for_body_s_c0_enter4437_conv2d1x10
...
module conv2d1x1_i_sfc_logic_s_c0_in_for_body_s_c0_enter4437_conv2d1x10 (
    input wire [31:0] in_input_size,
    output wire [0:0] out_c0_exi147_0_tpl,
    output wire [31:0] out_c0_exi147_1_tpl,
    output wire [0:0] out_o_valid,
    output wire [0:0] out_unnamed_conv2d1x11,
    input wire [0:0] in_c0_eni243_0_tpl,
    input wire [63:0] in_c0_eni243_1_tpl,
    input wire [31:0] in_c0_eni243_2_tpl,
    ...
    wire [31:0] i_llvm_fpga_sync_buffer_i32_input_size_sync_buffer4_conv2d1x13_out_buffer_out;
    ...
    reg [31:0] redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_outputreg0_q;
    wire redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_mem_reset0;
    wire [31:0] redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_mem_ia;
    wire [1:0] redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_mem_aa;
    wire [1:0] redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_mem_ab;
    wire [31:0] redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_mem_iq;
    wire [31:0] redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_mem_q;
    wire [1:0] redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_rdcnt_q;
    (* preserve *) reg [1:0] redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_rdcnt_i;
    (* preserve *) reg redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_rdcnt_eq;
    reg [1:0] redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_wraddr_q;
    wire [1:0] redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_mem_last_q;
    wire [0:0] redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_cmp_q;
    (* dont_merge *) reg [0:0] redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_cmpReg_q;
    wire [0:0] redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_notEnable_q;
    wire [0:0] redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_nor_q;
    (* dont_merge *) reg [0:0] redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_sticky_ena_q;
    wire [0:0] redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_enaAnd_q;
    ...
    // i_llvm_fpga_sync_buffer_i32_input_size_sync_buffer4_conv2d1x13(BLACKBOX,7)@0
    // in in_i_dependence@2
    // in in_valid_in@2
    // out out_buffer_out@2
    // out out_valid_out@2
    conv2d1x1_i_llvm_fpga_sync_buffer_i32_input_size_sync_buffer4_0 thei_llvm_fpga_sync_buffer_i32_input_size_sync_buffer4_conv2d1x13 (
        .in_buffer_in(in_input_size),
        .in_i_dependence(GND_q),
        .in_stall_in(GND_q),
        .in_valid_in(valid_fanout_reg1_q),
        .out_buffer_out(i_llvm_fpga_sync_buffer_i32_input_size_sync_buffer4_conv2d1x13_out_buffer_out),
        .out_stall_out(),
        .out_valid_out(),
        .clock(clock),
        .resetn(resetn)
    ...
    assign i_mul8_conv2d1x14_bs2_merged_bit_select_b = i_llvm_fpga_sync_buffer_i32_input_size_sync_buffer4_conv2d1x13_out_buffer_out[31:18];
    assign i_mul8_conv2d1x14_bs2_merged_bit_select_c = i_llvm_fpga_sync_buffer_i32_input_size_sync_buffer4_conv2d1x13_out_buffer_out[17:0];

    // i_conv2_conv2d1x12_sel_x(BITSELECT,13)@1
    assign i_conv2_conv2d1x12_sel_x_b = in_c0_eni243_1_tpl[31:0];
    ...
    // redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_notEnable(LOGICAL,52)
    assign redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_notEnable_q = $unsigned(~ (VCC_q));

    // redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_nor(LOGICAL,53)
    assign redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_nor_q = ~ (redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_notEnable_q | redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_sticky_ena_q);

    // redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_mem_last(CONSTANT,49)
    assign redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_mem_last_q = $unsigned(2'b01);

    // redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_cmp(LOGICAL,50)
    assign redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_cmp_q = $unsigned(redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_mem_last_q == redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_rdcnt_q ? 1'b1 : 1'b0);

    // redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_cmpReg(REG,51)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_cmpReg_q <= $unsigned(1'b0);
        end
        else
        begin
            redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_cmpReg_q <= $unsigned(redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_cmp_q);
        end
    end

    // redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_sticky_ena(REG,54)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_sticky_ena_q <= $unsigned(1'b0);
        end
        else if (redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_nor_q == 1'b1)
        begin
            redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_sticky_ena_q <= $unsigned(redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_cmpReg_q);
        end
    end

    // redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_enaAnd(LOGICAL,55)
    assign redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_enaAnd_q = redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_sticky_ena_q & VCC_q;

    // redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_rdcnt(COUNTER,47)
    // low=0, high=2, step=1, init=0
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_rdcnt_i <= 2'd0;
            redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_rdcnt_eq <= 1'b0;
        end
        else
        begin
            if (redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_rdcnt_i == 2'd1)
            begin
                redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_rdcnt_eq <= 1'b1;
            end
            else
            begin
                redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_rdcnt_eq <= 1'b0;
            end
            if (redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_rdcnt_eq == 1'b1)
            begin
                redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_rdcnt_i <= $unsigned(redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_rdcnt_i) + $unsigned(2'd2);
            end
            else
            begin
                redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_rdcnt_i <= $unsigned(redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_rdcnt_i) + $unsigned(2'd1);
            end
        end
    end
    assign redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_rdcnt_q = redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_rdcnt_i[1:0];

    // redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_wraddr(REG,48)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_wraddr_q <= $unsigned(2'b10);
        end
        else
        begin
            redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_wraddr_q <= $unsigned(redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_rdcnt_q);
        end
    end

    // redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_mem(DUALMEM,46)
    assign redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_mem_ia = $unsigned(in_c0_eni243_2_tpl);
    assign redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_mem_aa = redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_wraddr_q;
    assign redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_mem_ab = redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_rdcnt_q;
    assign redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_mem_reset0 = ~ (resetn);
    altera_syncram #(
        .ram_block_type("MLAB"),
    ...
    ) redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_mem_dmem (
        .clocken1(redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_enaAnd_q[0]),
        .clocken0(1'b1),
        .clock0(clock),
        .aclr1(redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_mem_reset0),
        .clock1(clock),
        .address_a(redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_mem_aa),
        .data_a(redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_mem_ia),
        .wren_a(VCC_q[0]),
        .address_b(redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_mem_ab),
        .q_b(redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_mem_iq),
        .wren_b(),
        .rden_a(),
        .rden_b(),
        .data_b(),
    ...
    assign redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_mem_q = redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_mem_iq[31:0];

    // redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_outputreg0(DELAY,45)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_outputreg0_q <= '0;
        end
        else
        begin
            redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_outputreg0_q <= $unsigned(redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_mem_q);
        end
    end

    // i_add_conv2d1x15(ADD,5)@6
    assign i_add_conv2d1x15_a = {1'b0, redist1_sync_together11_aunroll_x_in_c0_eni243_2_tpl_5_outputreg0_q};
