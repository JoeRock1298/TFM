...
module conv2d1x1_bb_B0 (
    ...
    wire [63:0] bb_conv2d1x1_B0_stall_region_out_c0_exe2;
    wire [31:0] bb_conv2d1x1_B0_stall_region_out_c0_exe4;
    wire [63:0] bb_conv2d1x1_B0_stall_region_out_c0_exe5;
    ...
    wire [31:0] bb_conv2d1x1_B0_stall_region_out_l_grpid_0;
    ...
    wire [0:0] bb_conv2d1x1_B0_stall_region_out_wgl_0_enter_exit_stall_out;
    wire [0:0] bb_conv2d1x1_B0_stall_region_out_wgl_0_enter_exit_valid_out;
    wire [63:0] conv2d1x1_B0_branch_out_acl_global_id_1;
    wire [63:0] conv2d1x1_B0_branch_out_c0_exe1;
    wire [63:0] conv2d1x1_B0_branch_out_c0_exe2;
    wire [31:0] conv2d1x1_B0_branch_out_c0_exe4;
    wire [63:0] conv2d1x1_B0_branch_out_c0_exe5;
    ...
    wire [31:0] conv2d1x1_B0_branch_out_l_grpid_0;
    ...
    wire [31:0] conv2d1x1_B0_merge_out_acl_hw_wg_id;
    wire [31:0] conv2d1x1_B0_merge_out_acl_local_linear_id;
    ...
    conv2d1x1_B0_merge theconv2d1x1_B0_merge (
        ...
        .out_acl_hw_wg_id(conv2d1x1_B0_merge_out_acl_hw_wg_id),
        .out_acl_local_linear_id(conv2d1x1_B0_merge_out_acl_local_linear_id),
    ...
    conv2d1x1_bb_B0_stall_region thebb_conv2d1x1_B0_stall_region (
        ...
        .in_acl_hw_wg_id(conv2d1x1_B0_merge_out_acl_hw_wg_id),
        .in_acl_local_linear_id(conv2d1x1_B0_merge_out_acl_local_linear_id),
        ...
        .out_c0_exe2(bb_conv2d1x1_B0_stall_region_out_c0_exe2),
        ...
        .out_l_grpid_0(bb_conv2d1x1_B0_stall_region_out_l_grpid_0),
        ...
        .out_wgl_0_enter_exit_stall_out(bb_conv2d1x1_B0_stall_region_out_wgl_0_enter_exit_stall_out),
        .out_wgl_0_enter_exit_valid_out(bb_conv2d1x1_B0_stall_region_out_wgl_0_enter_exit_valid_out),
        .clock(clock),
        .resetn(resetn)
    );
    ...
    conv2d1x1_B0_branch theconv2d1x1_B0_branch (
        ...
        .in_c0_exe2(bb_conv2d1x1_B0_stall_region_out_c0_exe2),
        ...
        .in_l_grpid_0(bb_conv2d1x1_B0_stall_region_out_l_grpid_0),
        ...
        .out_c0_exe2(conv2d1x1_B0_branch_out_c0_exe2),
        ...
        .out_l_grpid_0(conv2d1x1_B0_branch_out_l_grpid_0),
    ...
    assign out_c0_exe2 = conv2d1x1_B0_branch_out_c0_exe2;
    ...
    // out_l_grpid_0(GPOUT,34)
    assign out_l_grpid_0 = conv2d1x1_B0_branch_out_l_grpid_0;

    // out_stall_out_0(GPOUT,35)
    assign out_stall_out_0 = conv2d1x1_B0_merge_out_stall_out_0;

    // out_unnamed_conv2d1x10(GPOUT,36)
    assign out_unnamed_conv2d1x10 = conv2d1x1_B0_branch_out_unnamed_conv2d1x10;

    // out_unnamed_conv2d1x10_conv2d1x1_avm_address(GPOUT,37)
    ...
    // out_unnamed_conv2d1x10_conv2d1x1_avm_burstcount(GPOUT,38)
    ...
    // out_unnamed_conv2d1x10_conv2d1x1_avm_byteenable(GPOUT,39)
    ...
    // out_unnamed_conv2d1x10_conv2d1x1_avm_enable(GPOUT,40)
    ...
    // out_unnamed_conv2d1x10_conv2d1x1_avm_writedata(GPOUT,43)
    ...
    // out_wgl_0_enter_exit_stall_out(GPOUT,45)
    assign out_wgl_0_enter_exit_stall_out = bb_conv2d1x1_B0_stall_region_out_wgl_0_enter_exit_stall_out;

    // out_wgl_0_enter_exit_valid_out(GPOUT,46)
    assign out_wgl_0_enter_exit_valid_out = bb_conv2d1x1_B0_stall_region_out_wgl_0_enter_exit_valid_out;
