...
(
   ...
   // INST conv1x1_NDRange_locmem_sys of conv1x1_NDRange_locmem_sys
   conv1x1_NDRange_locmem_sys conv1x1_NDRange_locmem_sys
   (
      ...
      .avm_mem_gmem_0_DDR_port_0_0_rw_enable(kernel_mem0_enable),
      .avm_mem_gmem_0_DDR_port_0_0_rw_read(kernel_mem0_read),
      .avm_mem_gmem_0_DDR_port_0_0_rw_write(kernel_mem0_write),
      .avm_mem_gmem_0_DDR_port_0_0_rw_address(kernel_mem0_address),
      .avm_mem_gmem_0_DDR_port_0_0_rw_writedata(kernel_mem0_writedata),
      .avm_mem_gmem_0_DDR_port_0_0_rw_byteenable(kernel_mem0_byteenable),
      .avm_mem_gmem_0_DDR_port_0_0_rw_waitrequest(kernel_mem0_waitrequest),
      .avm_mem_gmem_0_DDR_port_0_0_rw_readdata(kernel_mem0_readdata),
      .avm_mem_gmem_0_DDR_port_0_0_rw_readdatavalid(kernel_mem0_readdatavalid),
      .avm_mem_gmem_0_DDR_port_0_0_rw_burstcount(kernel_mem0_burstcount),
      .avm_mem_gmem_0_DDR_port_0_0_rw_writeack(kernel_mem0_writeack),
