...
module conv2d1x1_bb_B0_stall_region (
    ...
    wire [33:0] i_cmp1263_conv2d1x16_a;
    wire [33:0] i_cmp1263_conv2d1x16_b;
    logic [33:0] i_cmp1263_conv2d1x16_o;
    wire [0:0] i_cmp1263_conv2d1x16_c;
    wire [33:0] i_cmp71_conv2d1x12_a;
    wire [33:0] i_cmp71_conv2d1x12_b;
    logic [33:0] i_cmp71_conv2d1x12_o;
    wire [0:0] i_cmp71_conv2d1x12_c;
    ...
    wire [0:0] i_smax32_conv2d1x120_s;
    reg [31:0] i_smax32_conv2d1x120_q;
    ...
    // i_smax32_conv2d1x120(MUX,33)@2
    assign i_smax32_conv2d1x120_s = i_unnamed_conv2d1x117_c;
    always @(i_smax32_conv2d1x120_s or c_i32_132_q or bubble_select_i_llvm_fpga_sync_buffer_i32_filter_size_sync_buffer5_conv2d1x119_b)
    begin
        unique case (i_smax32_conv2d1x120_s)
            1'b0 : i_smax32_conv2d1x120_q = c_i32_132_q;
            1'b1 : i_smax32_conv2d1x120_q = bubble_select_i_llvm_fpga_sync_buffer_i32_filter_size_sync_buffer5_conv2d1x119_b;
            default : i_smax32_conv2d1x120_q = 32'b0;
        endcase
    end

    // i_unnamed_conv2d1x121(ADD,42)@2
    assign i_unnamed_conv2d1x121_a = {1'b0, i_smax32_conv2d1x120_q};
    ...
    // i_cmp1263_conv2d1x16(COMPARE,18)@1
    assign i_cmp1263_conv2d1x16_a = $unsigned({{2{c_i32_031_recast_x_q[31]}}, c_i32_031_recast_x_q});
    assign i_cmp1263_conv2d1x16_b = $unsigned({{2{bubble_select_i_llvm_fpga_sync_buffer_i32_input_channels_sync_buffer_conv2d1x15_b[31]}}, bubble_select_i_llvm_fpga_sync_buffer_i32_input_channels_sync_buffer_conv2d1x15_b});
    assign i_cmp1263_conv2d1x16_o = $unsigned($signed(i_cmp1263_conv2d1x16_a) - $signed(i_cmp1263_conv2d1x16_b));
    assign i_cmp1263_conv2d1x16_c[0] = i_cmp1263_conv2d1x16_o[33];
    ...
    conv2d1x1_i_llvm_fpga_ffwd_source_i1_unnamed_2_conv2d1x10 thei_llvm_fpga_ffwd_source_i1_unnamed_conv2d1x12_conv2d1x126 (
        .in_predicate_in(GND_q),
        .in_src_data_in_2_0(i_cmp1263_conv2d1x16_c),
    ...
    // i_cmp71_conv2d1x12(COMPARE,19)@1
    assign i_cmp71_conv2d1x12_a = $unsigned({{2{c_i32_031_recast_x_q[31]}}, c_i32_031_recast_x_q});
    assign i_cmp71_conv2d1x12_b = $unsigned({{2{bubble_select_i_llvm_fpga_sync_buffer_i32_filter_size_sync_buffer_conv2d1x11_b[31]}}, bubble_select_i_llvm_fpga_sync_buffer_i32_filter_size_sync_buffer_conv2d1x11_b});
    assign i_cmp71_conv2d1x12_o = $unsigned($signed(i_cmp71_conv2d1x12_a) - $signed(i_cmp71_conv2d1x12_b));
    assign i_cmp71_conv2d1x12_c[0] = i_cmp71_conv2d1x12_o[33];
    ...
    conv2d1x1_i_llvm_fpga_ffwd_source_i1_unnamed_0_conv2d1x10 thei_llvm_fpga_ffwd_source_i1_unnamed_conv2d1x10_conv2d1x124 (
        .in_predicate_in(GND_q),
        .in_src_data_in_0_0(i_cmp71_conv2d1x12_c),
