...
module conv2d1x1_bb_B2 (
    ...
    wire [0:0] bb_conv2d1x1_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going44_conv2d1x12_exiting_stall_out;
    wire [0:0] bb_conv2d1x1_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going44_conv2d1x12_exiting_valid_out;
    ...
    wire [0:0] conv2d1x1_B2_merge_out_forked17;
    ...
    conv2d1x1_B2_merge theconv2d1x1_B2_merge (
        ...
        .out_forked17(conv2d1x1_B2_merge_out_forked17),
    ...
    conv2d1x1_bb_B2_stall_region thebb_conv2d1x1_B2_stall_region (
        ...
        .in_flush(in_flush),
        .in_forked17(conv2d1x1_B2_merge_out_forked17),
        ...
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going44_conv2d1x12_exiting_stall_out(bb_conv2d1x1_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going44_conv2d1x12_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going44_conv2d1x12_exiting_valid_out(bb_conv2d1x1_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going44_conv2d1x12_exiting_valid_out),
    ...
    assign out_exiting_stall_out = bb_conv2d1x1_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going44_conv2d1x12_exiting_stall_out;

    // out_exiting_valid_out(GPOUT,33)
    assign out_exiting_valid_out = bb_conv2d1x1_B2_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going44_conv2d1x12_exiting_valid_out;
