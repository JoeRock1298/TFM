...
// SystemVerilog created from conv2d3x3_bb_B6_sr_0
...
module conv2d3x3_bb_B6_sr_0 (
    ...
    // out_o_stall(GPOUT,53)
    assign out_o_stall = sr_valid_q;

    // out_o_valid(GPOUT,54)
