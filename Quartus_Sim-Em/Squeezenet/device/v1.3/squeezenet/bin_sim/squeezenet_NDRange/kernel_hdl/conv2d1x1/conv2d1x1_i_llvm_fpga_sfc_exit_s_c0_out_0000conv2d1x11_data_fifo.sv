...
module conv2d1x1_i_llvm_fpga_sfc_exit_s_c0_out_0000conv2d1x11_data_fifo (
    ...
    wire [383:0] i_llvm_fpga_sfc_exit_s_c0_out_entry_conv2d1x1s_c0_exit_conv2d1x10_i_data;
    ...
    wire [383:0] i_llvm_fpga_sfc_exit_s_c0_out_entry_conv2d1x1s_c0_exit_conv2d1x10_o_data;
    ...
    assign element_extension15_q = {c_i7_010_q, in_i_data_9_tpl};

    // element_extension13(BITJOIN,19)
    assign element_extension13_q = {c_i7_010_q, in_i_data_8_tpl};
    ...
    assign dsdk_ip_adapt_bitjoin1_q = {c_i24_017_q, element_extension15_q, element_extension13_q, element_extension11_q, element_extension9_q, element_extension7_q, in_i_data_4_tpl, c_i32_06_q, in_i_data_3_tpl, in_i_data_2_tpl, in_i_data_1_tpl, c_i56_05_q, element_extension3_q};

    // i_llvm_fpga_sfc_exit_s_c0_out_entry_conv2d1x1s_c0_exit_conv2d1x10(EXTIFACE,24)
    ...
    assign ip_dsdk_adapt_bitselect37_b = i_llvm_fpga_sfc_exit_s_c0_out_entry_conv2d1x1s_c0_exit_conv2d1x10_o_data[352:352];
    ...
    assign ip_dsdk_adapt_bitselect35_b = i_llvm_fpga_sfc_exit_s_c0_out_entry_conv2d1x1s_c0_exit_conv2d1x10_o_data[344:344];
    ...
    assign ip_dsdk_adapt_bitselect33_b = i_llvm_fpga_sfc_exit_s_c0_out_entry_conv2d1x1s_c0_exit_conv2d1x10_o_data[336:336];
    ...
    assign ip_dsdk_adapt_bitselect31_b = i_llvm_fpga_sfc_exit_s_c0_out_entry_conv2d1x1s_c0_exit_conv2d1x10_o_data[328:328];
    ...
    assign ip_dsdk_adapt_bitselect29_b = i_llvm_fpga_sfc_exit_s_c0_out_entry_conv2d1x1s_c0_exit_conv2d1x10_o_data[320:320];
    ...
    assign ip_dsdk_adapt_bitselect27_b = i_llvm_fpga_sfc_exit_s_c0_out_entry_conv2d1x1s_c0_exit_conv2d1x10_o_data[319:256];

    // ip_dsdk_adapt_bitselect25(BITSELECT,28)
    assign ip_dsdk_adapt_bitselect25_b = i_llvm_fpga_sfc_exit_s_c0_out_entry_conv2d1x1s_c0_exit_conv2d1x10_o_data[223:192];

    // ip_dsdk_adapt_bitselect23(BITSELECT,27)
    assign ip_dsdk_adapt_bitselect23_b = i_llvm_fpga_sfc_exit_s_c0_out_entry_conv2d1x1s_c0_exit_conv2d1x10_o_data[191:128];

    // ip_dsdk_adapt_bitselect21(BITSELECT,26)
    assign ip_dsdk_adapt_bitselect21_b = i_llvm_fpga_sfc_exit_s_c0_out_entry_conv2d1x1s_c0_exit_conv2d1x10_o_data[127:64];

    // ip_dsdk_adapt_bitselect19(BITSELECT,25)
    assign ip_dsdk_adapt_bitselect19_b = i_llvm_fpga_sfc_exit_s_c0_out_entry_conv2d1x1s_c0_exit_conv2d1x10_o_data[0:0];
