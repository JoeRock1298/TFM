...
module maxpool2d_B3_branch (
    ...
    input wire [31:0] in_c0_exe1172,
    input wire [31:0] in_c0_exe2173,
    ...
    // out_c0_exe1172(GPOUT,14)
    assign out_c0_exe1172 = in_c0_exe1172;

    // out_c0_exe2173(GPOUT,15)
    assign out_c0_exe2173 = in_c0_exe2173;

    // out_c0_exe4175(GPOUT,16)
    assign out_c0_exe4175 = in_c0_exe4175;
