...
module conv2d1x1_bb_B3_sr_1 (
    ...
    input wire [32:0] in_i_data_4_tpl,
    ...
    output wire [32:0] out_o_data_4_tpl,
    ...
    begin
        if (!resetn)
        begin
            sr_4_x_q <= $unsigned(33'b000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
