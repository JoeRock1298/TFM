...
// SystemVerilog created from conv2d3x3_B8_branch
...
module conv2d3x3_B8_branch (
    ...
    // out_add48_2(GPOUT,26)
    assign out_add48_2 = in_add48_2;

    // out_c0_exe1087(GPOUT,27)
    assign out_c0_exe1087 = in_c0_exe1087;

    // out_c0_exe1186155(GPOUT,28)
    assign out_c0_exe1186155 = in_c0_exe1186155;

    // out_c0_exe1197(GPOUT,29)
    assign out_c0_exe1197 = in_c0_exe1197;

    // out_c0_exe1234176(GPOUT,30)
    assign out_c0_exe1234176 = in_c0_exe1234176;

    // out_c0_exe1242(GPOUT,31)
    assign out_c0_exe1242 = in_c0_exe1242;

    // out_c0_exe1298(GPOUT,32)
    assign out_c0_exe1298 = in_c0_exe1298;

    // out_c0_exe13108(GPOUT,33)
    assign out_c0_exe13108 = in_c0_exe13108;

    // out_c0_exe14117(GPOUT,34)
    assign out_c0_exe14117 = in_c0_exe14117;

    // out_c0_exe15127(GPOUT,35)
    assign out_c0_exe15127 = in_c0_exe15127;

    // out_c0_exe16137(GPOUT,36)
    assign out_c0_exe16137 = in_c0_exe16137;

    // out_c0_exe18(GPOUT,37)
    assign out_c0_exe18 = in_c0_exe18;

    // out_c0_exe319(GPOUT,38)
    assign out_c0_exe319 = in_c0_exe319;

    // out_c0_exe428(GPOUT,39)
    assign out_c0_exe428 = in_c0_exe428;

    // out_c0_exe539(GPOUT,40)
    assign out_c0_exe539 = in_c0_exe539;

    // out_c0_exe646(GPOUT,41)
    assign out_c0_exe646 = in_c0_exe646;

    // out_c0_exe758(GPOUT,42)
    assign out_c0_exe758 = in_c0_exe758;

    // out_c0_exe867(GPOUT,43)
    assign out_c0_exe867 = in_c0_exe867;

    // out_c0_exe977(GPOUT,44)
    assign out_c0_exe977 = in_c0_exe977;

    // out_j_062146(GPOUT,45)
    assign out_j_062146 = in_j_062146;

    // out_k_059160(GPOUT,46)
    assign out_k_059160 = in_k_059160;
    ...
    assign out_unnamed_conv2d3x312 = in_unnamed_conv2d3x312;
