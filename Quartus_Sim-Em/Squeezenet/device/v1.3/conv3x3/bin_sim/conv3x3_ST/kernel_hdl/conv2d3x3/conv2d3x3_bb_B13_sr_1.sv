...
// SystemVerilog created from conv2d3x3_bb_B13_sr_1
...
module conv2d3x3_bb_B13_sr_1 (
    ...
    // out_o_stall(GPOUT,101)
    assign out_o_stall = sr_valid_q;

    // out_o_valid(GPOUT,102)
