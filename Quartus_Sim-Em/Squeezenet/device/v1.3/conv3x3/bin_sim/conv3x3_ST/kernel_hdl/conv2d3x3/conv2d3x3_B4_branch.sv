...
module conv2d3x3_B4_branch (
    input wire [0:0] in_c0_exe151152102,
    ...
    wire [0:0] VCC_q;
    wire [0:0] c0_exe151152102_cmp_q;
    ...
    // c0_exe151152102_cmp(LOGICAL,2)
    assign c0_exe151152102_cmp_q = ~ (in_c0_exe151152102);

    // valid_out_1_and(LOGICAL,21)
    assign valid_out_1_and_q = in_valid_in & c0_exe151152102_cmp_q;
    ...
    assign valid_out_0_and_q = in_valid_in & in_c0_exe151152102;
