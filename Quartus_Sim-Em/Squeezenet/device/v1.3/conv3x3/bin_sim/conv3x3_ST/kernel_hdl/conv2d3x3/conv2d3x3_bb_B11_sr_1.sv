...
// SystemVerilog created from conv2d3x3_bb_B11_sr_1
...
module conv2d3x3_bb_B11_sr_1 (
    ...
    // out_o_stall(GPOUT,103)
    assign out_o_stall = sr_valid_q;

    // out_o_valid(GPOUT,104)
    ...
    begin
        unique case (data_mux_40_x_s)
            ...
            default : data_mux_40_x_q = 1'b0;
        endcase
    end

    // out_o_data_40_tpl(GPOUT,145)
