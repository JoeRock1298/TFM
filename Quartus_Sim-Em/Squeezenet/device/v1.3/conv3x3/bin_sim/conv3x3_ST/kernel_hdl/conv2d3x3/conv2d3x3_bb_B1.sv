...
module conv2d3x3_bb_B1 (
    ...
    wire [0:0] bb_conv2d3x3_B1_stall_region_out_feedback_out_0;
    wire [0:0] bb_conv2d3x3_B1_stall_region_out_feedback_valid_out_0;
    ...
    conv2d3x3_bb_B1_stall_region thebb_conv2d3x3_B1_stall_region (
        ...
        .out_feedback_out_0(bb_conv2d3x3_B1_stall_region_out_feedback_out_0),
        .out_feedback_valid_out_0(bb_conv2d3x3_B1_stall_region_out_feedback_valid_out_0),
    ...
    assign out_feedback_out_0 = bb_conv2d3x3_B1_stall_region_out_feedback_out_0;

    // feedback_valid_out_0_sync(GPOUT,7)
    assign out_feedback_valid_out_0 = bb_conv2d3x3_B1_stall_region_out_feedback_valid_out_0;
