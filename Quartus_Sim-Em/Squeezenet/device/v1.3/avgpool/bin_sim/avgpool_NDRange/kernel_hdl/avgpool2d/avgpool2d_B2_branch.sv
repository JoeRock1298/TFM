...
// SystemVerilog created from avgpool2d_B2_branch
...
module avgpool2d_B2_branch (
    input wire [31:0] in_c0_exe116,
    ...
    wire [0:0] VCC_q;
    wire [0:0] avgpool2d_B2_branch_enable_q;
    wire [0:0] avgpool2d_B2_branch_enable_not_q;
    reg [31:0] c0_exe116_reg_q;
    ...
    begin
        ...
        else if (avgpool2d_B2_branch_enable_q == 1'b1)
        begin
    ...
    // avgpool2d_B2_branch_enable(LOGICAL,2)
    assign avgpool2d_B2_branch_enable_q = not_valid_or_not_stall_0_q & not_valid_or_not_stall_1_q;
    ...
    begin
        if (!resetn)
        begin
            c0_exe116_reg_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (avgpool2d_B2_branch_enable_q == 1'b1)
        begin
            c0_exe116_reg_q <= $unsigned(in_c0_exe116);
        end
    end
    ...
    // avgpool2d_B2_branch_enable_not(LOGICAL,3)
    assign avgpool2d_B2_branch_enable_not_q = ~ (avgpool2d_B2_branch_enable_q);

    // out_stall_out(GPOUT,27)
    assign out_stall_out = avgpool2d_B2_branch_enable_not_q;
