...
module hello_world_function (
    ...
    wire [30:0] bb_hello_world_B0_out_unnamed_hello_world0_hello_world_avm_address;
    ...
    // out_o_active_unnamed_hello_world0(GPOUT,19)
    ...
    // out_unnamed_hello_world0_hello_world_avm_address(GPOUT,21)
    ...
    // out_unnamed_hello_world0_hello_world_avm_burstcount(GPOUT,22)
    ...
    // out_unnamed_hello_world0_hello_world_avm_byteenable(GPOUT,23)
