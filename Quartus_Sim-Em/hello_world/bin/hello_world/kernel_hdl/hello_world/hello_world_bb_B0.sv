...
module hello_world_bb_B0 (
    ...
    wire [30:0] bb_hello_world_B0_stall_region_out_unnamed_hello_world0_hello_world_avm_address;
    ...
    // out_lsu_unnamed_hello_world0_o_active(GPOUT,15)
    ...
    // out_unnamed_hello_world0_hello_world_avm_address(GPOUT,17)
    ...
    // out_unnamed_hello_world0_hello_world_avm_burstcount(GPOUT,18)
    ...
    // out_unnamed_hello_world0_hello_world_avm_byteenable(GPOUT,19)
    ...
    // out_unnamed_hello_world0_hello_world_avm_enable(GPOUT,20)
    ...
    // out_unnamed_hello_world0_hello_world_avm_read(GPOUT,21)
    ...
    // out_unnamed_hello_world0_hello_world_avm_write(GPOUT,22)
    ...
    // out_unnamed_hello_world0_hello_world_avm_writedata(GPOUT,23)
