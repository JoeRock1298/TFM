...
set_module_property NAME hello_world_sys
set_module_property VERSION 14.0
set_module_property INTERNAL false
set_module_property GROUP Accelerators
set_module_property DISPLAY_NAME hello_world_sys
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL hello_world_sys
...
add_fileset_file "hello_world_sys.v" SYSTEM_VERILOG PATH "hello_world_sys.v" TOP_LEVEL_FILE
...
add_fileset_file "hello_world_i_llvm_fpga_sync_buffer_i32_0000ssage_sync_buffer1_0.sv" SYSTEM_VERILOG PATH "kernel_hdl/hello_world/hello_world_i_llvm_fpga_sync_buffer_i32_0000ssage_sync_buffer1_0.sv" TOP_LEVEL_FILE
add_fileset_file "hello_world_i_llvm_fpga_sync_buffer_i32_0000essage_sync_buffer_0.sv" SYSTEM_VERILOG PATH "kernel_hdl/hello_world/hello_world_i_llvm_fpga_sync_buffer_i32_0000essage_sync_buffer_0.sv" TOP_LEVEL_FILE
add_fileset_file "hello_world_i_llvm_fpga_sync_buffer_p1024i32_id_sync_buffer_0.sv" SYSTEM_VERILOG PATH "kernel_hdl/hello_world/hello_world_i_llvm_fpga_sync_buffer_p1024i32_id_sync_buffer_0.sv" TOP_LEVEL_FILE
...
set_fileset_property SIM_VERILOG TOP_LEVEL hello_world_sys
add_fileset_file "acl_reset_handler.sv" SYSTEM_VERILOG PATH "$::env(INTELFPGAOCLSDKROOT)/ip/acl_reset_handler.sv" TOP_LEVEL_FILE
add_fileset_file "acl_work_group_dispatcher.v" SYSTEM_VERILOG PATH "$::env(INTELFPGAOCLSDKROOT)/ip/acl_work_group_dispatcher.v" TOP_LEVEL_FILE
add_fileset_file "acl_kernel_finish_detector.v" SYSTEM_VERILOG PATH "$::env(INTELFPGAOCLSDKROOT)/ip/acl_kernel_finish_detector.v" TOP_LEVEL_FILE
add_fileset_file "acl_multistage_accumulator.v" SYSTEM_VERILOG PATH "$::env(INTELFPGAOCLSDKROOT)/ip/acl_multistage_accumulator.v" TOP_LEVEL_FILE
